...
| **Extracted text** | **~30G** (~29.675B chars, **≈7.419B tokens**) |
| **Cleaned corpus** | **~29G** (~28.558B chars, **≈7.139B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 139,891 · building_energy 94,313 · construction 78,322 · structures_civil 38,904 · materials 27,562 · infrastructure 16,434 · architecture 13,621 · standards_protocols 8,978 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 286,134 · public-domain 108,629 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
