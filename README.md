...
| **Extracted text** | **~78G** (~76.171B chars, **≈19.043B tokens**) |
| **Cleaned corpus** | **~74G** (~72.439B chars, **≈18.110B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 502,750 · construction 401,618 · building_energy 202,338 · structures_civil 161,104 · materials 104,756 · infrastructure 70,495 · architecture 42,421 · standards_protocols 11,555 · controls_bas 11,031 · urban 6,013 · commissioning_fdd 834.

**By license:** open 1,237,574 · public-domain 256,653 · cc-by-sa 1,734 · cc-by 18,954.
<!-- STATS:END -->
