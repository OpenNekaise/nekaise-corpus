...
| **Raw originals** | **~685G** (PDF / HTML / source code) |
| **Extracted text** | **~66G** (~65.158B chars, **≈16.289B tokens**) |
| **Cleaned corpus** | **~63G** (~62.147B chars, **≈15.537B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 401,057 · construction 302,143 · building_energy 173,647 · structures_civil 124,302 · materials 82,764 · infrastructure 54,777 · architecture 35,511 · standards_protocols 11,531 · controls_bas 10,472 · urban 6,003 · commissioning_fdd 826.

**By license:** open 954,102 · public-domain 228,562 · cc-by-sa 1,732 · cc-by 18,637.
