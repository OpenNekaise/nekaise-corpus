...
| **Extracted text** | **~66G** (~64.763B chars, **≈16.191B tokens**) |
| **Cleaned corpus** | **~63G** (~61.778B chars, **≈15.445B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 397,560 · construction 298,616 · building_energy 172,627 · structures_civil 122,983 · materials 81,903 · infrastructure 54,208 · architecture 35,253 · standards_protocols 11,531 · controls_bas 10,348 · urban 6,002 · commissioning_fdd 826.

**By license:** open 943,931 · public-domain 227,562 · cc-by-sa 1,732 · cc-by 18,632.
