...
| **Extracted text** | **~46G** (~45.236B chars, **≈11.309B tokens**) |
| **Cleaned corpus** | **~44G** (~43.444B chars, **≈10.861B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,282 · construction 140,949 · building_energy 128,865 · structures_civil 65,235 · materials 41,850 · infrastructure 27,998 · architecture 24,215 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 175,480 · cc-by-sa 1,723 · cc-by 18,183.
