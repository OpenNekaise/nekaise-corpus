...
| **Extracted text** | **~32G** (~31.272B chars, **≈7.818B tokens**) |
| **Cleaned corpus** | **~30G** (~30.046B chars, **≈7.512B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 158,343 · building_energy 99,974 · construction 84,464 · structures_civil 41,911 · materials 29,668 · infrastructure 17,927 · architecture 14,819 · standards_protocols 9,497 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 317,722 · public-domain 115,619 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
