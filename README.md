...
| **Extracted text** | **~64G** (~62.626B chars, **≈15.656B tokens**) |
| **Cleaned corpus** | **~61G** (~59.782B chars, **≈14.946B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 377,598 · construction 278,599 · building_energy 167,012 · structures_civil 115,549 · materials 77,345 · infrastructure 50,968 · architecture 33,733 · standards_protocols 11,529 · controls_bas 9,841 · urban 6,001 · commissioning_fdd 826.

**By license:** open 885,903 · public-domain 222,798 · cc-by-sa 1,732 · cc-by 18,568.
