...
| **Extracted text** | **~66G** (~64.501B chars, **≈16.125B tokens**) |
| **Cleaned corpus** | **~63G** (~61.534B chars, **≈15.383B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 395,167 · construction 296,180 · building_energy 171,952 · structures_civil 122,076 · materials 81,388 · infrastructure 53,832 · architecture 35,069 · standards_protocols 11,531 · controls_bas 10,348 · urban 6,002 · commissioning_fdd 826.

**By license:** open 937,017 · public-domain 226,999 · cc-by-sa 1,732 · cc-by 18,623.
