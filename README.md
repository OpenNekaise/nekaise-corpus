...
| **Raw originals** | **~643G** (PDF / HTML / source code) |
| **Extracted text** | **~57G** (~55.968B chars, **≈13.992B tokens**) |
| **Cleaned corpus** | **~54G** (~53.557B chars, **≈13.389B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 316,900 · construction 219,315 · building_energy 150,205 · structures_civil 94,067 · materials 63,913 · infrastructure 41,021 · architecture 28,925 · standards_protocols 11,520 · controls_bas 7,797 · urban 5,996 · commissioning_fdd 819.

**By license:** open 713,908 · public-domain 206,455 · cc-by-sa 1,732 · cc-by 18,383.
