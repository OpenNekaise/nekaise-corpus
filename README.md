...
| **Extracted text** | **~66G** (~64.859B chars, **≈16.215B tokens**) |
| **Cleaned corpus** | **~63G** (~61.868B chars, **≈15.467B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 398,363 · construction 299,390 · building_energy 172,857 · structures_civil 123,284 · materials 82,116 · infrastructure 54,338 · architecture 35,307 · standards_protocols 11,531 · controls_bas 10,470 · urban 6,002 · commissioning_fdd 826.

**By license:** open 946,373 · public-domain 227,747 · cc-by-sa 1,732 · cc-by 18,632.
