...
| **Extracted text** | **~45G** (~44.709B chars, **≈11.177B tokens**) |
| **Cleaned corpus** | **~44G** (~42.931B chars, **≈10.733B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 233,478 · construction 139,945 · building_energy 128,299 · structures_civil 64,816 · materials 41,668 · infrastructure 27,834 · architecture 24,061 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,570 · public-domain 171,072 · cc-by-sa 1,723 · cc-by 18,183.
