...
| **Extracted text** | **~67G** (~65.448B chars, **≈16.362B tokens**) |
| **Cleaned corpus** | **~63G** (~62.419B chars, **≈15.605B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 403,574 · construction 304,624 · building_energy 174,378 · structures_civil 125,206 · materials 83,313 · infrastructure 55,169 · architecture 35,690 · standards_protocols 11,533 · controls_bas 10,668 · urban 6,003 · commissioning_fdd 826.

**By license:** open 961,373 · public-domain 229,239 · cc-by-sa 1,732 · cc-by 18,640.
