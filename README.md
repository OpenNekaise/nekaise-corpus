...
| **Extracted text** | **~40G** (~39.845B chars, **≈9.961B tokens**) |
| **Cleaned corpus** | **~39G** (~38.251B chars, **≈9.563B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 207,050 · building_energy 120,092 · construction 117,082 · structures_civil 54,903 · materials 36,584 · infrastructure 24,124 · architecture 21,671 · standards_protocols 10,878 · urban 5,886 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 413,660 · public-domain 149,091 · cc-by-sa 1,723 · cc-by 37,570.
