...
|---|---|
| **Documents** | **100,357** |
| **Raw originals** | **~276G** (PDF / HTML / source code) |
| **Extracted text** | **~13G** (~12.782B chars, **≈3.196B tokens**) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 38,428 · equipment_systems 21,408 · construction 14,746 · structures_civil 8,400 · materials 4,723 · infrastructure 3,677 · architecture 3,144 · standards_protocols 2,608 · urban 1,465 · controls_bas 1,385 · commissioning_fdd 373.

**By license:** open 36,520 · public-domain 48,891 · cc-by-sa 1,609 · cc-by 13,332 · proprietary-internal 5.
