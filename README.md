...
| **Extracted text** | **~34G** (~33.262B chars, **≈8.316B tokens**) |
| **Cleaned corpus** | **~32G** (~31.906B chars, **≈7.977B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 179,626 · building_energy 107,173 · construction 91,282 · structures_civil 44,995 · materials 31,830 · infrastructure 19,552 · architecture 16,781 · standards_protocols 10,184 · controls_bas 3,395 · urban 3,032 · commissioning_fdd 374.

**By license:** open 352,158 · public-domain 126,002 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
