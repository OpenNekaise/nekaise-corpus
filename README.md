...
| **Extracted text** | **~28G** (~28.188B chars, **≈7.047B tokens**) |
| **Cleaned corpus** | **~27G** (~27.166B chars, **≈6.791B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 123,581 · building_energy 89,099 · construction 71,631 · structures_civil 35,944 · materials 25,500 · infrastructure 15,143 · architecture 12,530 · standards_protocols 8,511 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 255,681 · public-domain 102,996 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
