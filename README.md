...
| **Extracted text** | **~81G** (~79.015B chars, **≈19.754B tokens**) |
| **Cleaned corpus** | **~77G** (~75.101B chars, **≈18.775B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 529,579 · construction 426,488 · building_energy 209,593 · structures_civil 170,611 · materials 110,270 · infrastructure 74,573 · architecture 44,436 · standards_protocols 11,561 · controls_bas 11,057 · urban 6,014 · commissioning_fdd 836.

**By license:** open 1,312,767 · public-domain 261,495 · cc-by-sa 1,736 · cc-by 19,020.
<!-- STATS:END -->
