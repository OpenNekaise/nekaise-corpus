...
| **Extracted text** | **~45G** (~44.453B chars, **≈11.113B tokens**) |
| **Cleaned corpus** | **~43G** (~42.684B chars, **≈10.671B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 232,503 · construction 139,323 · building_energy 128,021 · structures_civil 64,567 · materials 41,565 · infrastructure 27,743 · architecture 23,993 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,170 · public-domain 169,086 · cc-by-sa 1,723 · cc-by 18,183.
