...
| **Extracted text** | **~66G** (~64.245B chars, **≈16.061B tokens**) |
| **Cleaned corpus** | **~62G** (~61.294B chars, **≈15.323B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 392,719 · construction 293,956 · building_energy 171,289 · structures_civil 121,191 · materials 80,882 · infrastructure 53,493 · architecture 34,864 · standards_protocols 11,531 · controls_bas 10,237 · urban 6,002 · commissioning_fdd 826.

**By license:** open 930,027 · public-domain 226,613 · cc-by-sa 1,732 · cc-by 18,618.
