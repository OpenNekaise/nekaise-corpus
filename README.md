...
| **Extracted text** | **~46G** (~45.127B chars, **≈11.282B tokens**) |
| **Cleaned corpus** | **~44G** (~43.338B chars, **≈10.835B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 234,869 · construction 140,757 · building_energy 128,755 · structures_civil 65,136 · materials 41,810 · infrastructure 27,961 · architecture 24,187 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,455 · public-domain 174,561 · cc-by-sa 1,723 · cc-by 18,183.
