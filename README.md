...
| **Extracted text** | **~51G** (~50.542B chars, **≈12.635B tokens**) |
| **Cleaned corpus** | **~49G** (~48.455B chars, **≈12.114B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 272,950 · construction 176,184 · building_energy 138,752 · structures_civil 77,762 · materials 52,389 · infrastructure 34,147 · architecture 25,396 · standards_protocols 11,514 · urban 5,983 · controls_bas 4,741 · commissioning_fdd 816.

**By license:** open 586,729 · public-domain 193,928 · cc-by-sa 1,723 · cc-by 18,254.
