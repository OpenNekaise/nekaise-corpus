...
| **Extracted text** | **~41G** (~40.498B chars, **≈10.124B tokens**) |
| **Cleaned corpus** | **~39G** (~38.872B chars, **≈9.718B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 211,345 · building_energy 121,235 · construction 121,204 · structures_civil 56,500 · materials 37,428 · infrastructure 24,759 · architecture 21,990 · standards_protocols 10,878 · urban 5,886 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 424,432 · public-domain 151,274 · cc-by-sa 1,723 · cc-by 37,570.
