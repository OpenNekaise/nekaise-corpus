...
| **Extracted text** | **~56G** (~54.624B chars, **≈13.656B tokens**) |
| **Cleaned corpus** | **~53G** (~52.297B chars, **≈13.074B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 305,542 · construction 208,052 · building_energy 147,269 · structures_civil 89,932 · materials 60,856 · infrastructure 39,264 · architecture 28,100 · standards_protocols 11,519 · controls_bas 7,259 · urban 5,984 · commissioning_fdd 819.

**By license:** open 681,254 · public-domain 203,294 · cc-by-sa 1,723 · cc-by 18,325.
