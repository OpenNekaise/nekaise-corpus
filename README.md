...
|---|---|
| **Documents** | **592,034** |
| **Raw originals** | **~544G** (PDF / HTML / source code) |
| **Extracted text** | **~40G** (~39.335B chars, **≈9.834B tokens**) |
| **Cleaned corpus** | **~38G** (~37.765B chars, **≈9.441B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 204,180 · building_energy 119,288 · construction 113,191 · structures_civil 53,770 · materials 35,993 · infrastructure 23,632 · architecture 21,442 · standards_protocols 10,878 · urban 5,886 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 405,436 · public-domain 147,305 · cc-by-sa 1,723 · cc-by 37,570.
