...
| **Extracted text** | **~75G** (~73.735B chars, **≈18.434B tokens**) |
| **Cleaned corpus** | **~71G** (~70.160B chars, **≈17.540B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 480,535 · construction 380,118 · building_energy 196,053 · structures_civil 152,779 · materials 100,222 · infrastructure 67,260 · architecture 40,968 · standards_protocols 11,552 · controls_bas 11,029 · urban 6,010 · commissioning_fdd 832.

**By license:** open 1,176,072 · public-domain 250,676 · cc-by-sa 1,734 · cc-by 18,876.
<!-- STATS:END -->
