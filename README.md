...
| **Extracted text** | **~54G** (~52.820B chars, **≈13.205B tokens**) |
| **Cleaned corpus** | **~51G** (~50.600B chars, **≈12.650B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 290,912 · construction 193,609 · building_energy 143,408 · structures_civil 84,626 · materials 57,148 · infrastructure 37,051 · architecture 26,924 · standards_protocols 11,516 · controls_bas 6,109 · urban 5,983 · commissioning_fdd 819.

**By license:** open 639,010 · public-domain 199,079 · cc-by-sa 1,723 · cc-by 18,293.
