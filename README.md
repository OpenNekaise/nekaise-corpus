...
| **Extracted text** | **~79G** (~77.229B chars, **≈19.307B tokens**) |
| **Cleaned corpus** | **~75G** (~73.430B chars, **≈18.357B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 512,490 · construction 411,044 · building_energy 205,015 · structures_civil 164,621 · materials 106,718 · infrastructure 71,938 · architecture 43,137 · standards_protocols 11,560 · controls_bas 11,042 · urban 6,014 · commissioning_fdd 835.

**By license:** open 1,265,330 · public-domain 258,367 · cc-by-sa 1,735 · cc-by 18,982.
<!-- STATS:END -->
