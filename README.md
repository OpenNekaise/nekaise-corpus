...
| **Extracted text** | **~41G** (~40.284B chars, **≈10.071B tokens**) |
| **Cleaned corpus** | **~39G** (~38.669B chars, **≈9.667B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 209,778 · building_energy 120,811 · construction 119,700 · structures_civil 55,922 · materials 37,130 · infrastructure 24,555 · architecture 21,876 · standards_protocols 10,878 · urban 5,886 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 420,443 · public-domain 150,574 · cc-by-sa 1,723 · cc-by 37,570.
