...
|---|---|
| **Documents** | **311,784** |
| **Raw originals** | **~433G** (PDF / HTML / source code) |
| **Extracted text** | **~25G** (~25.064B chars, **≈6.266B tokens**) |
| **Cleaned corpus** | **~24G** (~24.246B chars, **≈6.061B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 90,397 · building_energy 77,184 · construction 57,496 · structures_civil 29,144 · materials 21,307 · infrastructure 12,179 · architecture 9,680 · standards_protocols 8,019 · urban 3,032 · controls_bas 2,972 · commissioning_fdd 374.

**By license:** open 190,554 · public-domain 91,166 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
