...
| **Extracted text** | **~82G** (~79.875B chars, **≈19.969B tokens**) |
| **Cleaned corpus** | **~78G** (~75.922B chars, **≈18.980B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,867 · construction 431,359 · building_energy 215,543 · structures_civil 172,585 · materials 111,431 · infrastructure 75,654 · architecture 45,279 · standards_protocols 11,899 · controls_bas 11,217 · urban 6,108 · commissioning_fdd 841.

**By license:** open 1,332,244 · public-domain 263,561 · cc-by-sa 1,737 · cc-by 20,241.
<!-- STATS:END -->
