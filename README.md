...
| **Extracted text** | **~41G** (~40.969B chars, **≈10.242B tokens**) |
| **Cleaned corpus** | **~40G** (~39.322B chars, **≈9.831B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 214,281 · construction 123,840 · building_energy 122,134 · structures_civil 57,596 · materials 37,947 · infrastructure 25,166 · architecture 22,239 · standards_protocols 10,878 · urban 5,886 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 449,808 · public-domain 154,026 · cc-by-sa 1,723 · cc-by 18,184.
