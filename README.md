...
| **Extracted text** | **~82G** (~79.764B chars, **≈19.941B tokens**) |
| **Cleaned corpus** | **~77G** (~75.810B chars, **≈18.953B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,803 · construction 431,344 · building_energy 213,347 · structures_civil 172,585 · materials 111,388 · infrastructure 75,654 · architecture 45,274 · standards_protocols 11,570 · controls_bas 11,186 · urban 6,096 · commissioning_fdd 841.

**By license:** open 1,330,328 · public-domain 263,001 · cc-by-sa 1,736 · cc-by 20,023.
<!-- STATS:END -->
