...
| **Extracted text** | **~26G** (~25.960B chars, **≈6.490B tokens**) |
| **Cleaned corpus** | **~25G** (~25.086B chars, **≈6.271B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 99,339 · building_energy 80,719 · construction 61,527 · structures_civil 31,087 · materials 22,588 · infrastructure 13,006 · architecture 10,518 · standards_protocols 8,153 · controls_bas 3,167 · urban 3,032 · commissioning_fdd 374.

**By license:** open 209,103 · public-domain 94,343 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
