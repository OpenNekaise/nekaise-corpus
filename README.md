...
|---|---|
| **Documents** | **686,552** |
| **Raw originals** | **~581G** (PDF / HTML / source code) |
| **Extracted text** | **~46G** (~45.201B chars, **≈11.300B tokens**) |
| **Cleaned corpus** | **~44G** (~43.410B chars, **≈10.853B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,162 · construction 140,888 · building_energy 128,832 · structures_civil 65,195 · materials 41,835 · infrastructure 27,986 · architecture 24,206 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 175,190 · cc-by-sa 1,723 · cc-by 18,183.
