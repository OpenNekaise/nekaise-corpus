...
| **Extracted text** | **~82G** (~79.924B chars, **≈19.981B tokens**) |
| **Cleaned corpus** | **~78G** (~75.970B chars, **≈18.993B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,874 · construction 431,363 · building_energy 216,186 · structures_civil 172,585 · materials 111,598 · infrastructure 75,654 · architecture 45,283 · standards_protocols 12,009 · controls_bas 11,234 · urban 6,110 · commissioning_fdd 841.

**By license:** open 1,332,953 · public-domain 263,703 · cc-by-sa 1,739 · cc-by 20,342.
<!-- STATS:END -->
