...
| **Extracted text** | **~46G** (~45.117B chars, **≈11.279B tokens**) |
| **Cleaned corpus** | **~44G** (~43.329B chars, **≈10.832B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 234,832 · construction 140,742 · building_energy 128,744 · structures_civil 65,128 · materials 41,808 · infrastructure 27,957 · architecture 24,184 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,455 · public-domain 174,481 · cc-by-sa 1,723 · cc-by 18,183.
