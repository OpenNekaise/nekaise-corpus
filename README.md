...
| **Raw originals** | **~655G** (PDF / HTML / source code) |
| **Extracted text** | **~60G** (~58.460B chars, **≈14.615B tokens**) |
| **Cleaned corpus** | **~57G** (~55.892B chars, **≈13.973B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 338,034 · construction 240,755 · building_energy 156,084 · structures_civil 101,765 · materials 68,520 · infrastructure 44,187 · architecture 30,447 · standards_protocols 11,523 · controls_bas 8,828 · urban 5,997 · commissioning_fdd 821.

**By license:** open 774,197 · public-domain 212,575 · cc-by-sa 1,732 · cc-by 18,457.
