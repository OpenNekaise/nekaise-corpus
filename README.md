...
| **Raw originals** | **~607G** (PDF / HTML / source code) |
| **Extracted text** | **~52G** (~50.961B chars, **≈12.740B tokens**) |
| **Cleaned corpus** | **~49G** (~48.849B chars, **≈12.212B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 275,934 · construction 179,419 · building_energy 139,647 · structures_civil 79,043 · materials 53,306 · infrastructure 34,681 · architecture 25,699 · standards_protocols 11,514 · urban 5,983 · controls_bas 4,936 · commissioning_fdd 818.

**By license:** open 596,105 · public-domain 194,887 · cc-by-sa 1,723 · cc-by 18,265.
