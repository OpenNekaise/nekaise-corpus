...
| **Extracted text** | **~81G** (~79.159B chars, **≈19.790B tokens**) |
| **Cleaned corpus** | **~77G** (~75.235B chars, **≈18.809B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 531,038 · construction 427,662 · building_energy 209,965 · structures_civil 171,090 · materials 110,562 · infrastructure 74,799 · architecture 44,514 · standards_protocols 11,561 · controls_bas 11,057 · urban 6,014 · commissioning_fdd 836.

**By license:** open 1,316,617 · public-domain 261,724 · cc-by-sa 1,736 · cc-by 19,021.
<!-- STATS:END -->
