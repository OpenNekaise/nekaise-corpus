...
|---|---|
| **Documents** | **68,471** |
| **Raw originals** | **~212G** (PDF / HTML / source code) |
| **Extracted text** | **~9.3G** (~9.606B chars, **≈2.401B tokens**) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 25,786 · equipment_systems 14,464 · construction 9,211 · structures_civil 6,572 · materials 3,402 · architecture 2,536 · infrastructure 2,503 · standards_protocols 1,642 · controls_bas 1,144 · urban 842 · commissioning_fdd 369.

**By license:** open 20,689 · public-domain 38,410 · cc-by-sa 1,605 · cc-by 7,762 · proprietary-internal 5.
