...
|---|---|
| **Documents** | **66,996** |
| **Raw originals** | **~208G** (PDF / HTML / source code) |
| **Extracted text** | **~9.1G** (~9.446B chars, **≈2.362B tokens**) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 25,149 · equipment_systems 14,184 · construction 9,031 · structures_civil 6,434 · materials 3,351 · architecture 2,518 · infrastructure 2,461 · standards_protocols 1,597 · controls_bas 1,121 · urban 781 · commissioning_fdd 369.

**By license:** open 20,187 · public-domain 37,824 · cc-by-sa 1,605 · cc-by 7,375 · proprietary-internal 5.
