...
| **Extracted text** | **~63G** (~61.998B chars, **≈15.499B tokens**) |
| **Cleaned corpus** | **~60G** (~59.196B chars, **≈14.799B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 371,770 · construction 272,606 · building_energy 165,324 · structures_civil 113,329 · materials 75,967 · infrastructure 49,756 · architecture 33,239 · standards_protocols 11,527 · controls_bas 9,716 · urban 6,001 · commissioning_fdd 825.

**By license:** open 868,507 · public-domain 221,259 · cc-by-sa 1,732 · cc-by 18,562.
