...
| **Extracted text** | **~80G** (~78.527B chars, **≈19.632B tokens**) |
| **Cleaned corpus** | **~76G** (~74.645B chars, **≈18.661B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 524,820 · construction 422,363 · building_energy 208,327 · structures_civil 168,942 · materials 109,276 · infrastructure 73,820 · architecture 44,065 · standards_protocols 11,561 · controls_bas 11,055 · urban 6,014 · commissioning_fdd 836.

**By license:** open 1,299,615 · public-domain 260,714 · cc-by-sa 1,736 · cc-by 19,014.
<!-- STATS:END -->
