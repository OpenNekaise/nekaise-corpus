...
| **Extracted text** | **~46G** (~45.499B chars, **≈11.375B tokens**) |
| **Cleaned corpus** | **~44G** (~43.699B chars, **≈10.925B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 236,318 · construction 141,482 · building_energy 129,152 · structures_civil 65,463 · materials 41,963 · infrastructure 28,076 · architecture 24,300 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 177,840 · cc-by-sa 1,723 · cc-by 18,183.
