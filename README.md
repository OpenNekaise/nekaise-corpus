...
| **Raw originals** | **~623G** (PDF / HTML / source code) |
| **Extracted text** | **~54G** (~52.890B chars, **≈13.222B tokens**) |
| **Cleaned corpus** | **~51G** (~50.665B chars, **≈12.666B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 291,485 · construction 194,214 · building_energy 143,570 · structures_civil 84,833 · materials 57,254 · infrastructure 37,142 · architecture 26,989 · standards_protocols 11,516 · controls_bas 6,110 · urban 5,983 · commissioning_fdd 819.

**By license:** open 640,636 · public-domain 199,263 · cc-by-sa 1,723 · cc-by 18,293.
