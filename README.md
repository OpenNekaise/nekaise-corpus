...
| **Extracted text** | **~46G** (~45.258B chars, **≈11.315B tokens**) |
| **Cleaned corpus** | **~44G** (~43.466B chars, **≈10.866B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,350 · construction 141,007 · building_energy 128,881 · structures_civil 65,254 · materials 41,862 · infrastructure 28,002 · architecture 24,221 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 175,663 · cc-by-sa 1,723 · cc-by 18,183.
