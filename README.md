...
| **Extracted text** | **~82G** (~79.739B chars, **≈19.935B tokens**) |
| **Cleaned corpus** | **~77G** (~75.786B chars, **≈18.946B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,734 · construction 431,337 · building_energy 212,694 · structures_civil 172,585 · materials 111,387 · infrastructure 75,654 · architecture 45,272 · standards_protocols 11,568 · controls_bas 11,177 · urban 6,091 · commissioning_fdd 840.

**By license:** open 1,329,793 · public-domain 262,788 · cc-by-sa 1,736 · cc-by 20,022.
<!-- STATS:END -->
