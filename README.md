...
| **Extracted text** | **~82G** (~79.936B chars, **≈19.984B tokens**) |
| **Cleaned corpus** | **~78G** (~75.982B chars, **≈18.995B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,874 · construction 431,364 · building_energy 216,461 · structures_civil 172,585 · materials 111,634 · infrastructure 75,654 · architecture 45,285 · standards_protocols 12,075 · controls_bas 11,234 · urban 6,113 · commissioning_fdd 841.

**By license:** open 1,333,223 · public-domain 263,788 · cc-by-sa 1,739 · cc-by 20,370.
<!-- STATS:END -->
