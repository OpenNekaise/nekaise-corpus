...
| **Extracted text** | **~64G** (~62.721B chars, **≈15.680B tokens**) |
| **Cleaned corpus** | **~61G** (~59.871B chars, **≈14.968B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 378,445 · construction 279,471 · building_energy 167,266 · structures_civil 115,940 · materials 77,554 · infrastructure 51,126 · architecture 33,801 · standards_protocols 11,529 · controls_bas 9,841 · urban 6,001 · commissioning_fdd 826.

**By license:** open 888,398 · public-domain 223,095 · cc-by-sa 1,732 · cc-by 18,575.
