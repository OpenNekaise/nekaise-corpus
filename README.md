...
| **Extracted text** | **~34G** (~33.297B chars, **≈8.324B tokens**) |
| **Cleaned corpus** | **~32G** (~31.938B chars, **≈7.985B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 180,036 · building_energy 107,285 · construction 91,440 · structures_civil 45,045 · materials 31,855 · infrastructure 19,585 · architecture 16,799 · standards_protocols 10,188 · controls_bas 3,395 · urban 3,032 · commissioning_fdd 374.

**By license:** open 352,737 · public-domain 126,233 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
