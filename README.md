...
| **Extracted text** | **~47G** (~32.999B chars, **≈8.250B tokens**) |
| **Cleaned corpus** | **~31G** (~32.122B chars, **≈8.031B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 86,166 · equipment_systems 72,107 · construction 50,387 · structures_civil 20,876 · materials 17,175 · architecture 12,379 · standards_protocols 11,501 · infrastructure 10,060 · urban 5,982 · controls_bas 4,125 · commissioning_fdd 804.

**By license:** open 88,620 · public-domain 183,039 · cc-by-sa 1,723 · cc-by 18,180.
