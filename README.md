...
|---|---|
| **Documents** | **76,653** |
| **Raw originals** | **~230G** (PDF / HTML / source code) |
| **Extracted text** | **~11G** (~10.400B chars, **≈2.600B tokens**) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 28,943 · equipment_systems 16,456 · construction 10,768 · structures_civil 6,944 · materials 3,686 · infrastructure 2,776 · architecture 2,660 · standards_protocols 1,829 · controls_bas 1,290 · urban 932 · commissioning_fdd 369.

**By license:** open 24,731 · public-domain 41,392 · cc-by-sa 1,605 · cc-by 8,920 · proprietary-internal 5.
