...
| **Extracted text** | **~62G** (~60.267B chars, **≈15.067B tokens**) |
| **Cleaned corpus** | **~59G** (~57.580B chars, **≈14.395B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 355,037 · construction 256,837 · building_energy 160,692 · structures_civil 107,819 · materials 72,286 · infrastructure 46,870 · architecture 31,781 · standards_protocols 11,525 · controls_bas 9,343 · urban 5,999 · commissioning_fdd 823.

**By license:** open 821,714 · public-domain 217,054 · cc-by-sa 1,732 · cc-by 18,512.
