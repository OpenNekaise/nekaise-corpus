...
| **Extracted text** | **~80G** (~78.300B chars, **≈19.575B tokens**) |
| **Cleaned corpus** | **~76G** (~74.432B chars, **≈18.608B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 522,593 · construction 420,414 · building_energy 207,732 · structures_civil 168,216 · materials 108,839 · infrastructure 73,483 · architecture 43,906 · standards_protocols 11,561 · controls_bas 11,055 · urban 6,014 · commissioning_fdd 836.

**By license:** open 1,293,562 · public-domain 260,343 · cc-by-sa 1,736 · cc-by 19,008.
<!-- STATS:END -->
