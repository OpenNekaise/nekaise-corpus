...
| **Extracted text** | **~60G** (~58.937B chars, **≈14.734B tokens**) |
| **Cleaned corpus** | **~57G** (~56.338B chars, **≈14.084B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 342,171 · construction 244,680 · building_energy 157,279 · structures_civil 103,334 · materials 69,417 · infrastructure 44,836 · architecture 30,734 · standards_protocols 11,523 · controls_bas 8,967 · urban 5,999 · commissioning_fdd 822.

**By license:** open 785,873 · public-domain 213,692 · cc-by-sa 1,732 · cc-by 18,465.
