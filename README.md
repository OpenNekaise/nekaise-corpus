...
| **Extracted text** | **~47G** (~46.725B chars, **≈11.681B tokens**) |
| **Cleaned corpus** | **~45G** (~44.862B chars, **≈11.215B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 244,622 · construction 145,487 · building_energy 130,706 · structures_civil 66,275 · materials 43,755 · infrastructure 29,172 · architecture 22,630 · standards_protocols 11,501 · urban 5,983 · controls_bas 4,231 · commissioning_fdd 804.

**By license:** open 499,515 · public-domain 185,735 · cc-by-sa 1,723 · cc-by 18,193.
