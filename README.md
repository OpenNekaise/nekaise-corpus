...
|---|---|
| **Documents** | **63,877** |
| **Raw originals** | **~200G** (PDF / HTML / source code) |
| **Extracted text** | **~8.8G** (~9.102B chars, **≈2.275B tokens**) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 23,924 · equipment_systems 13,479 · construction 8,483 · structures_civil 6,177 · materials 3,250 · architecture 2,478 · infrastructure 2,345 · standards_protocols 1,579 · controls_bas 1,060 · urban 733 · commissioning_fdd 369.

**By license:** open 18,543 · public-domain 36,755 · cc-by-sa 1,601 · cc-by 6,973 · proprietary-internal 5.
