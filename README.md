...
| **Extracted text** | **~58G** (~57.020B chars, **≈14.255B tokens**) |
| **Cleaned corpus** | **~55G** (~54.544B chars, **≈13.636B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 325,559 · construction 228,472 · building_energy 152,615 · structures_civil 97,268 · materials 66,008 · infrastructure 42,316 · architecture 29,582 · standards_protocols 11,521 · controls_bas 8,324 · urban 5,997 · commissioning_fdd 819.

**By license:** open 739,311 · public-domain 209,019 · cc-by-sa 1,732 · cc-by 18,419.
