...
| **Raw originals** | **~616G** (PDF / HTML / source code) |
| **Extracted text** | **~53G** (~51.913B chars, **≈12.978B tokens**) |
| **Cleaned corpus** | **~50G** (~49.746B chars, **≈12.436B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 283,514 · construction 186,689 · building_energy 141,545 · structures_civil 81,836 · materials 55,311 · infrastructure 35,928 · architecture 26,339 · standards_protocols 11,515 · urban 5,983 · controls_bas 5,503 · commissioning_fdd 819.

**By license:** open 617,952 · public-domain 197,034 · cc-by-sa 1,723 · cc-by 18,273.
