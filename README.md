...
| **Extracted text** | **~69G** (~67.897B chars, **≈16.974B tokens**) |
| **Cleaned corpus** | **~66G** (~64.707B chars, **≈16.177B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 425,674 · construction 326,765 · building_energy 180,812 · structures_civil 133,544 · materials 88,714 · infrastructure 58,648 · architecture 37,334 · standards_protocols 11,542 · controls_bas 10,990 · urban 6,005 · commissioning_fdd 830.

**By license:** open 1,025,317 · public-domain 235,108 · cc-by-sa 1,732 · cc-by 18,701.
