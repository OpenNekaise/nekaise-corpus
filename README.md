...
| **Extracted text** | **~55G** (~53.906B chars, **≈13.477B tokens**) |
| **Cleaned corpus** | **~52G** (~51.621B chars, **≈12.905B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 299,686 · construction 202,250 · building_energy 145,727 · structures_civil 87,864 · materials 59,294 · infrastructure 38,433 · architecture 27,725 · standards_protocols 11,518 · controls_bas 6,772 · urban 5,984 · commissioning_fdd 819.

**By license:** open 664,432 · public-domain 201,607 · cc-by-sa 1,723 · cc-by 18,310.
