...
| **Extracted text** | **~57G** (~55.787B chars, **≈13.947B tokens**) |
| **Cleaned corpus** | **~54G** (~53.388B chars, **≈13.347B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 315,310 · construction 217,756 · building_energy 149,827 · structures_civil 93,552 · materials 63,480 · infrastructure 40,804 · architecture 28,818 · standards_protocols 11,520 · controls_bas 7,755 · urban 5,996 · commissioning_fdd 819.

**By license:** open 709,472 · public-domain 206,056 · cc-by-sa 1,732 · cc-by 18,377.
