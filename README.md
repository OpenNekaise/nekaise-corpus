...
| **Extracted text** | **~29G** (~28.553B chars, **≈7.138B tokens**) |
| **Cleaned corpus** | **~28G** (~27.507B chars, **≈6.877B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 127,631 · building_energy 90,411 · construction 72,975 · structures_civil 36,715 · materials 26,074 · infrastructure 15,451 · architecture 12,811 · standards_protocols 8,616 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 263,016 · public-domain 104,406 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
