...
| **Raw originals** | **~596G** (PDF / HTML / source code) |
| **Extracted text** | **~49G** (~48.424B chars, **≈12.106B tokens**) |
| **Cleaned corpus** | **~47G** (~46.467B chars, **≈11.617B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 257,222 · construction 158,584 · building_energy 134,089 · structures_civil 71,242 · materials 47,425 · infrastructure 31,334 · architecture 23,953 · standards_protocols 11,502 · urban 5,983 · controls_bas 4,535 · commissioning_fdd 810.

**By license:** open 537,777 · public-domain 188,961 · cc-by-sa 1,723 · cc-by 18,218.
