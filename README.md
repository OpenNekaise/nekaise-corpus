...
| **Raw originals** | **~752G** (PDF / HTML / source code) |
| **Extracted text** | **~82G** (~79.860B chars, **≈19.965B tokens**) |
| **Cleaned corpus** | **~78G** (~75.906B chars, **≈18.977B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,867 · construction 431,358 · building_energy 215,399 · structures_civil 172,585 · materials 111,431 · infrastructure 75,654 · architecture 45,279 · standards_protocols 11,869 · controls_bas 11,212 · urban 6,108 · commissioning_fdd 841.

**By license:** open 1,332,123 · public-domain 263,529 · cc-by-sa 1,737 · cc-by 20,214.
<!-- STATS:END -->
