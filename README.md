...
| **Extracted text** | **~64G** (~62.989B chars, **≈15.747B tokens**) |
| **Cleaned corpus** | **~61G** (~60.122B chars, **≈15.030B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 381,038 · construction 281,994 · building_energy 168,004 · structures_civil 116,820 · materials 78,168 · infrastructure 51,551 · architecture 34,003 · standards_protocols 11,529 · controls_bas 9,934 · urban 6,001 · commissioning_fdd 826.

**By license:** open 895,793 · public-domain 223,761 · cc-by-sa 1,732 · cc-by 18,582.
