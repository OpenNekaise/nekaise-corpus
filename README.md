...
| **Extracted text** | **~56G** (~54.533B chars, **≈13.633B tokens**) |
| **Cleaned corpus** | **~53G** (~52.211B chars, **≈13.053B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 304,825 · construction 207,301 · building_energy 147,088 · structures_civil 89,668 · materials 60,571 · infrastructure 39,137 · architecture 28,063 · standards_protocols 11,519 · controls_bas 7,216 · urban 5,984 · commissioning_fdd 819.

**By license:** open 679,054 · public-domain 203,094 · cc-by-sa 1,723 · cc-by 18,320.
