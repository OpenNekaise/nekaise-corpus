...
| **Extracted text** | **~40G** (~39.975B chars, **≈9.994B tokens**) |
| **Cleaned corpus** | **~39G** (~38.376B chars, **≈9.594B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 207,854 · building_energy 120,290 · construction 117,859 · structures_civil 55,217 · materials 36,738 · infrastructure 24,253 · architecture 21,728 · standards_protocols 10,878 · urban 5,886 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 415,657 · public-domain 149,527 · cc-by-sa 1,723 · cc-by 37,570.
