...
| **Extracted text** | **~81G** (~79.118B chars, **≈19.780B tokens**) |
| **Cleaned corpus** | **~77G** (~75.197B chars, **≈18.799B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 530,633 · construction 427,347 · building_energy 209,853 · structures_civil 170,952 · materials 110,488 · infrastructure 74,741 · architecture 44,485 · standards_protocols 11,561 · controls_bas 11,057 · urban 6,014 · commissioning_fdd 836.

**By license:** open 1,315,554 · public-domain 261,656 · cc-by-sa 1,736 · cc-by 19,021.
<!-- STATS:END -->
