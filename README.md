...
| **Extracted text** | **~64G** (~62.537B chars, **≈15.634B tokens**) |
| **Cleaned corpus** | **~61G** (~59.700B chars, **≈14.925B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 376,820 · construction 277,753 · building_energy 166,772 · structures_civil 115,227 · materials 77,143 · infrastructure 50,788 · architecture 33,668 · standards_protocols 11,529 · controls_bas 9,839 · urban 6,001 · commissioning_fdd 826.

**By license:** open 883,512 · public-domain 222,554 · cc-by-sa 1,732 · cc-by 18,568.
