...
| **Extracted text** | **~25G** (~24.900B chars, **≈6.225B tokens**) |
| **Cleaned corpus** | **~24G** (~24.093B chars, **≈6.023B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 88,703 · building_energy 76,587 · construction 56,764 · structures_civil 28,800 · materials 21,067 · infrastructure 12,016 · architecture 9,532 · standards_protocols 7,999 · urban 3,032 · controls_bas 2,972 · commissioning_fdd 374.

**By license:** open 187,255 · public-domain 90,527 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
