...
| **Extracted text** | **~68G** (~66.374B chars, **≈16.593B tokens**) |
| **Cleaned corpus** | **~64G** (~63.284B chars, **≈15.821B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 411,960 · construction 313,050 · building_energy 176,705 · structures_civil 128,379 · materials 85,341 · infrastructure 56,467 · architecture 36,305 · standards_protocols 11,534 · controls_bas 10,985 · urban 6,003 · commissioning_fdd 827.

**By license:** open 985,665 · public-domain 231,487 · cc-by-sa 1,732 · cc-by 18,672.
