...
|---|---|
| **Documents** | **92,074** |
| **Raw originals** | **~268G** (PDF / HTML / source code) |
| **Extracted text** | **~12G** (~12.136B chars, **≈3.034B tokens**) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 36,013 · equipment_systems 19,428 · construction 13,058 · structures_civil 7,766 · materials 4,333 · infrastructure 3,377 · architecture 2,954 · standards_protocols 2,113 · controls_bas 1,385 · urban 1,274 · commissioning_fdd 373.

**By license:** open 31,051 · public-domain 47,788 · cc-by-sa 1,607 · cc-by 11,623 · proprietary-internal 5.
