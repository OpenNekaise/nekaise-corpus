...
| **Extracted text** | **~55G** (~53.985B chars, **≈13.496B tokens**) |
| **Cleaned corpus** | **~52G** (~51.696B chars, **≈12.924B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 300,257 · construction 202,853 · building_energy 145,903 · structures_civil 88,074 · materials 59,427 · infrastructure 38,514 · architecture 27,766 · standards_protocols 11,518 · controls_bas 6,940 · urban 5,984 · commissioning_fdd 819.

**By license:** open 666,239 · public-domain 201,783 · cc-by-sa 1,723 · cc-by 18,310.
