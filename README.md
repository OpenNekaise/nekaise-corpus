...
| **Extracted text** | **~46G** (~32.750B chars, **≈8.187B tokens**) |
| **Cleaned corpus** | **~31G** (~31.882B chars, **≈7.970B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 85,836 · equipment_systems 71,108 · construction 49,804 · structures_civil 20,685 · materials 17,086 · architecture 12,313 · standards_protocols 11,509 · infrastructure 9,983 · urban 5,982 · controls_bas 4,149 · commissioning_fdd 832.

**By license:** open 88,716 · public-domain 180,656 · cc-by-sa 1,723 · cc-by 18,192.
