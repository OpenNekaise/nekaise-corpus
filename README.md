...
| **Extracted text** | **~40G** (~39.365B chars, **≈9.841B tokens**) |
| **Cleaned corpus** | **~38G** (~37.794B chars, **≈9.449B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 204,346 · building_energy 119,336 · construction 113,523 · structures_civil 53,829 · materials 36,026 · infrastructure 23,663 · architecture 21,458 · standards_protocols 10,878 · urban 5,886 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 406,020 · public-domain 147,406 · cc-by-sa 1,723 · cc-by 37,570.
