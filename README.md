...
| **Raw originals** | **~600G** (PDF / HTML / source code) |
| **Extracted text** | **~50G** (~49.569B chars, **≈12.392B tokens**) |
| **Cleaned corpus** | **~48G** (~47.543B chars, **≈11.886B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 265,549 · construction 167,707 · building_energy 136,604 · structures_civil 74,741 · materials 49,920 · infrastructure 32,782 · architecture 24,746 · standards_protocols 11,503 · urban 5,983 · controls_bas 4,594 · commissioning_fdd 811.

**By license:** open 563,438 · public-domain 191,548 · cc-by-sa 1,723 · cc-by 18,231.
