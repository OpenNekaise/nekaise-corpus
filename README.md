...
| **Extracted text** | **~53G** (~52.279B chars, **≈13.070B tokens**) |
| **Cleaned corpus** | **~51G** (~50.090B chars, **≈12.523B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 286,548 · construction 189,392 · building_energy 142,300 · structures_civil 83,003 · materials 56,045 · infrastructure 36,394 · architecture 26,568 · standards_protocols 11,515 · urban 5,983 · controls_bas 5,782 · commissioning_fdd 819.

**By license:** open 626,512 · public-domain 197,836 · cc-by-sa 1,723 · cc-by 18,278.
