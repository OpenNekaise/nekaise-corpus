...
| **Extracted text** | **~82G** (~79.840B chars, **≈19.960B tokens**) |
| **Cleaned corpus** | **~78G** (~75.886B chars, **≈18.972B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,867 · construction 431,356 · building_energy 214,919 · structures_civil 172,585 · materials 111,431 · infrastructure 75,654 · architecture 45,279 · standards_protocols 11,813 · controls_bas 11,211 · urban 6,108 · commissioning_fdd 841.

**By license:** open 1,331,707 · public-domain 263,462 · cc-by-sa 1,737 · cc-by 20,158.
<!-- STATS:END -->
