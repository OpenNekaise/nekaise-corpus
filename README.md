...
| **Extracted text** | **~65G** (~63.874B chars, **≈15.968B tokens**) |
| **Cleaned corpus** | **~62G** (~60.947B chars, **≈15.237B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 389,406 · construction 290,401 · building_energy 170,309 · structures_civil 119,914 · materials 80,096 · infrastructure 52,958 · architecture 34,635 · standards_protocols 11,531 · controls_bas 10,109 · urban 6,002 · commissioning_fdd 826.

**By license:** open 919,941 · public-domain 225,900 · cc-by-sa 1,732 · cc-by 18,614.
