...
| **Extracted text** | **~49G** (~48.516B chars, **≈12.129B tokens**) |
| **Cleaned corpus** | **~47G** (~46.553B chars, **≈11.638B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 257,996 · construction 159,309 · building_energy 134,270 · structures_civil 71,532 · materials 47,571 · infrastructure 31,450 · architecture 24,025 · standards_protocols 11,502 · urban 5,983 · controls_bas 4,535 · commissioning_fdd 810.

**By license:** open 539,866 · public-domain 189,173 · cc-by-sa 1,723 · cc-by 18,221.
