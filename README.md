...
| **Raw originals** | **~639G** (PDF / HTML / source code) |
| **Extracted text** | **~56G** (~55.112B chars, **≈13.778B tokens**) |
| **Cleaned corpus** | **~54G** (~52.755B chars, **≈13.189B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 309,753 · construction 212,090 · building_energy 148,351 · structures_civil 91,550 · materials 62,108 · infrastructure 39,911 · architecture 28,395 · standards_protocols 11,519 · controls_bas 7,436 · urban 5,996 · commissioning_fdd 819.

**By license:** open 693,410 · public-domain 204,417 · cc-by-sa 1,732 · cc-by 18,369.

_Snapshot of the eligible live registry (2026-09-02) — auto-generated from the manifest. Local raw/text
