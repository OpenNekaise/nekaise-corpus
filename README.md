...
| **Extracted text** | **~82G** (~79.964B chars, **≈19.991B tokens**) |
| **Cleaned corpus** | **~78G** (~76.010B chars, **≈19.002B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,881 · construction 431,403 · building_energy 216,964 · structures_civil 172,585 · materials 111,760 · infrastructure 75,654 · architecture 45,312 · standards_protocols 12,082 · controls_bas 11,253 · urban 6,114 · commissioning_fdd 841.

**By license:** open 1,333,923 · public-domain 263,808 · cc-by-sa 1,739 · cc-by 20,379.
<!-- STATS:END -->
