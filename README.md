...
| **Extracted text** | **~34G** (~33.120B chars, **≈8.280B tokens**) |
| **Cleaned corpus** | **~32G** (~31.773B chars, **≈7.943B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 178,101 · building_energy 106,659 · construction 90,733 · structures_civil 44,780 · materials 31,665 · infrastructure 19,445 · architecture 16,643 · standards_protocols 10,099 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 349,692 · public-domain 125,171 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
