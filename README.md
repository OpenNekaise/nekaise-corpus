...
| **Extracted text** | **~46G** (~45.335B chars, **≈11.334B tokens**) |
| **Cleaned corpus** | **~44G** (~43.540B chars, **≈10.885B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,648 · construction 141,152 · building_energy 128,960 · structures_civil 65,327 · materials 41,891 · infrastructure 28,021 · architecture 24,242 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 176,327 · cc-by-sa 1,723 · cc-by 18,183.
