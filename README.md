...
| **Extracted text** | **~80G** (~78.354B chars, **≈19.589B tokens**) |
| **Cleaned corpus** | **~76G** (~74.483B chars, **≈18.621B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 523,128 · construction 420,887 · building_energy 207,873 · structures_civil 168,398 · materials 108,944 · infrastructure 73,574 · architecture 43,935 · standards_protocols 11,561 · controls_bas 11,055 · urban 6,014 · commissioning_fdd 836.

**By license:** open 1,295,031 · public-domain 260,429 · cc-by-sa 1,736 · cc-by 19,009.
<!-- STATS:END -->
