...
| **Extracted text** | **~78G** (~76.847B chars, **≈19.212B tokens**) |
| **Cleaned corpus** | **~74G** (~73.072B chars, **≈18.268B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 508,905 · construction 407,716 · building_energy 204,046 · structures_civil 163,384 · materials 106,025 · infrastructure 71,408 · architecture 42,881 · standards_protocols 11,559 · controls_bas 11,035 · urban 6,014 · commissioning_fdd 835.

**By license:** open 1,255,387 · public-domain 257,707 · cc-by-sa 1,734 · cc-by 18,980.
<!-- STATS:END -->
