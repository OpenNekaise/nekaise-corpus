...
| **Extracted text** | **~59G** (~57.790B chars, **≈14.447B tokens**) |
| **Cleaned corpus** | **~56G** (~55.264B chars, **≈13.816B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 332,129 · construction 235,316 · building_energy 154,479 · structures_civil 99,732 · materials 67,414 · infrastructure 43,355 · architecture 30,032 · standards_protocols 11,523 · controls_bas 8,488 · urban 5,997 · commissioning_fdd 821.

**By license:** open 758,327 · public-domain 210,798 · cc-by-sa 1,732 · cc-by 18,429.
