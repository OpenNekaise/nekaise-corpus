...
| **Extracted text** | **~33G** (~32.257B chars, **≈8.064B tokens**) |
| **Cleaned corpus** | **~31G** (~30.966B chars, **≈7.741B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 169,209 · building_energy 103,630 · construction 87,884 · structures_civil 43,534 · materials 30,808 · infrastructure 18,752 · architecture 15,775 · standards_protocols 9,766 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 335,426 · public-domain 120,670 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
