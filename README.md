...
| **Extracted text** | **~66G** (~64.259B chars, **≈16.065B tokens**) |
| **Cleaned corpus** | **~62G** (~61.307B chars, **≈15.327B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 392,836 · construction 294,088 · building_energy 171,339 · structures_civil 121,251 · materials 80,917 · infrastructure 53,512 · architecture 34,873 · standards_protocols 11,531 · controls_bas 10,237 · urban 6,002 · commissioning_fdd 826.

**By license:** open 930,426 · public-domain 226,636 · cc-by-sa 1,732 · cc-by 18,618.
