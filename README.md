...
| **Extracted text** | **~58G** (~57.003B chars, **≈14.251B tokens**) |
| **Cleaned corpus** | **~55G** (~54.527B chars, **≈13.632B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 325,420 · construction 228,323 · building_energy 152,573 · structures_civil 97,219 · materials 65,985 · infrastructure 42,298 · architecture 29,573 · standards_protocols 11,521 · controls_bas 8,324 · urban 5,997 · commissioning_fdd 819.

**By license:** open 738,915 · public-domain 208,986 · cc-by-sa 1,732 · cc-by 18,419.
