...
| **Extracted text** | **~61G** (~59.992B chars, **≈14.998B tokens**) |
| **Cleaned corpus** | **~58G** (~57.323B chars, **≈14.331B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 352,432 · construction 254,155 · building_energy 160,006 · structures_civil 106,919 · materials 71,683 · infrastructure 46,434 · architecture 31,576 · standards_protocols 11,525 · controls_bas 9,262 · urban 5,999 · commissioning_fdd 823.

**By license:** open 814,203 · public-domain 216,383 · cc-by-sa 1,732 · cc-by 18,496.
