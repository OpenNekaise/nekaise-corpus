...
| **Extracted text** | **~33G** (~32.177B chars, **≈8.044B tokens**) |
| **Cleaned corpus** | **~31G** (~30.891B chars, **≈7.723B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 168,331 · building_energy 103,322 · construction 87,595 · structures_civil 43,407 · materials 30,710 · infrastructure 18,674 · architecture 15,704 · standards_protocols 9,731 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 334,023 · public-domain 120,189 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
