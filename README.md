...
| **Extracted text** | **~28G** (~27.786B chars, **≈6.946B tokens**) |
| **Cleaned corpus** | **~27G** (~26.791B chars, **≈6.698B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 118,988 · building_energy 87,471 · construction 69,922 · structures_civil 35,146 · materials 24,982 · infrastructure 14,804 · architecture 12,155 · standards_protocols 8,413 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 247,228 · public-domain 101,391 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
