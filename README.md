...
| **Extracted text** | **~65G** (~63.844B chars, **≈15.961B tokens**) |
| **Cleaned corpus** | **~62G** (~60.920B chars, **≈15.230B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 389,115 · construction 290,133 · building_energy 170,225 · structures_civil 119,819 · materials 80,040 · infrastructure 52,907 · architecture 34,608 · standards_protocols 11,531 · controls_bas 10,106 · urban 6,002 · commissioning_fdd 826.

**By license:** open 919,146 · public-domain 225,822 · cc-by-sa 1,732 · cc-by 18,612.
