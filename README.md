...
| **Extracted text** | **~81G** (~79.431B chars, **≈19.858B tokens**) |
| **Cleaned corpus** | **~77G** (~75.490B chars, **≈18.872B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 533,695 · construction 429,918 · building_energy 210,686 · structures_civil 171,990 · materials 111,084 · infrastructure 75,240 · architecture 44,707 · standards_protocols 11,562 · controls_bas 11,058 · urban 6,014 · commissioning_fdd 836.

**By license:** open 1,323,827 · public-domain 262,197 · cc-by-sa 1,736 · cc-by 19,030.
<!-- STATS:END -->
