...
| **Extracted text** | **~46G** (~45.395B chars, **≈11.349B tokens**) |
| **Cleaned corpus** | **~44G** (~43.598B chars, **≈10.900B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,886 · construction 141,270 · building_energy 129,030 · structures_civil 65,383 · materials 41,911 · infrastructure 28,040 · architecture 24,267 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 176,873 · cc-by-sa 1,723 · cc-by 18,183.
