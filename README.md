...
|---|---|
| **Documents** | **192,850** |
| **Raw originals** | **~368G** (PDF / HTML / source code) |
| **Extracted text** | **~19G** (~19.175B chars, **≈4.794B tokens**) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 54,407 · equipment_systems 46,772 · construction 34,887 · structures_civil 19,461 · materials 11,996 · infrastructure 8,107 · standards_protocols 6,048 · architecture 5,709 · urban 2,973 · controls_bas 2,117 · commissioning_fdd 373.

**By license:** open 95,095 · public-domain 69,921 · cc-by-sa 1,648 · cc-by 26,181 · proprietary-internal 5.
