...
| **Extracted text** | **~52G** (~50.579B chars, **≈12.645B tokens**) |
| **Cleaned corpus** | **~49G** (~48.490B chars, **≈12.123B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 273,212 · construction 176,479 · building_energy 138,820 · structures_civil 77,896 · materials 52,455 · infrastructure 34,183 · architecture 25,422 · standards_protocols 11,514 · urban 5,983 · controls_bas 4,741 · commissioning_fdd 816.

**By license:** open 587,524 · public-domain 194,018 · cc-by-sa 1,723 · cc-by 18,256.
