...
| **Extracted text** | **~39G** (~39.079B chars, **≈9.770B tokens**) |
| **Cleaned corpus** | **~38G** (~37.520B chars, **≈9.380B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 202,723 · building_energy 118,912 · construction 110,494 · structures_civil 53,244 · materials 35,740 · infrastructure 23,443 · architecture 21,320 · standards_protocols 10,878 · urban 5,886 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 400,759 · public-domain 146,362 · cc-by-sa 1,723 · cc-by 37,570.
