...
| **Extracted text** | **~75G** (~73.973B chars, **≈18.493B tokens**) |
| **Cleaned corpus** | **~72G** (~70.383B chars, **≈17.596B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 482,657 · construction 382,306 · building_energy 196,665 · structures_civil 153,624 · materials 100,702 · infrastructure 67,574 · architecture 41,107 · standards_protocols 11,552 · controls_bas 11,029 · urban 6,010 · commissioning_fdd 832.

**By license:** open 1,182,169 · public-domain 251,274 · cc-by-sa 1,734 · cc-by 18,881.
<!-- STATS:END -->
