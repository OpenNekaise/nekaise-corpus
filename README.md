...
| **Extracted text** | **~57G** (~55.845B chars, **≈13.961B tokens**) |
| **Cleaned corpus** | **~54G** (~53.443B chars, **≈13.361B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 315,777 · construction 218,186 · building_energy 149,943 · structures_civil 93,706 · materials 63,581 · infrastructure 40,882 · architecture 28,847 · standards_protocols 11,520 · controls_bas 7,794 · urban 5,996 · commissioning_fdd 819.

**By license:** open 710,747 · public-domain 206,191 · cc-by-sa 1,732 · cc-by 18,381.
