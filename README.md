...
| **Extracted text** | **~48G** (~47.664B chars, **≈11.916B tokens**) |
| **Cleaned corpus** | **~46G** (~45.750B chars, **≈11.437B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 251,530 · construction 152,559 · building_energy 132,574 · structures_civil 68,860 · materials 45,687 · infrastructure 30,282 · architecture 23,436 · standards_protocols 11,502 · urban 5,983 · controls_bas 4,432 · commissioning_fdd 810.

**By license:** open 519,861 · public-domain 187,868 · cc-by-sa 1,723 · cc-by 18,203.
