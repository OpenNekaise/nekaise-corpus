...
| **Extracted text** | **~46G** (~45.446B chars, **≈11.361B tokens**) |
| **Cleaned corpus** | **~44G** (~43.647B chars, **≈10.912B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 236,102 · construction 141,377 · building_energy 129,092 · structures_civil 65,415 · materials 41,944 · infrastructure 28,055 · architecture 24,285 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 177,356 · cc-by-sa 1,723 · cc-by 18,183.
