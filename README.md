...
|---|---|
| **Documents** | **688,788** |
| **Raw originals** | **~582G** (PDF / HTML / source code) |
| **Extracted text** | **~46G** (~45.456B chars, **≈11.364B tokens**) |
| **Cleaned corpus** | **~44G** (~43.658B chars, **≈10.914B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 236,116 · construction 141,397 · building_energy 129,106 · structures_civil 65,437 · materials 41,944 · infrastructure 28,055 · architecture 24,285 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 177,426 · cc-by-sa 1,723 · cc-by 18,183.
