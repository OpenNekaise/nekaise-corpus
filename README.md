...
| **Extracted text** | **~46G** (~45.556B chars, **≈11.389B tokens**) |
| **Cleaned corpus** | **~44G** (~43.754B chars, **≈10.939B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 236,538 · construction 141,599 · building_energy 129,231 · structures_civil 65,514 · materials 41,984 · infrastructure 28,093 · architecture 24,326 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 178,371 · cc-by-sa 1,723 · cc-by 18,183.
