...
| **Extracted text** | **~82G** (~79.927B chars, **≈19.982B tokens**) |
| **Cleaned corpus** | **~78G** (~75.973B chars, **≈18.993B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,874 · construction 431,364 · building_energy 216,206 · structures_civil 172,585 · materials 111,622 · infrastructure 75,654 · architecture 45,283 · standards_protocols 12,018 · controls_bas 11,234 · urban 6,110 · commissioning_fdd 841.

**By license:** open 1,332,971 · public-domain 263,715 · cc-by-sa 1,739 · cc-by 20,366.
<!-- STATS:END -->
