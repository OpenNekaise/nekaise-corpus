...
|---|---|
| **Documents** | **541,346** |
| **Raw originals** | **~504G** (PDF / HTML / source code) |
| **Extracted text** | **~36G** (~35.912B chars, **≈8.978B tokens**) |
| **Cleaned corpus** | **~35G** (~34.468B chars, **≈8.617B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 191,004 · building_energy 111,519 · construction 99,460 · structures_civil 48,919 · materials 33,702 · infrastructure 21,074 · architecture 17,878 · standards_protocols 10,835 · controls_bas 3,398 · urban 3,182 · commissioning_fdd 375.

**By license:** open 372,737 · public-domain 137,199 · cc-by-sa 1,720 · cc-by 29,685 · proprietary-internal 5.
