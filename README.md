...
| **Extracted text** | **~82G** (~79.934B chars, **≈19.984B tokens**) |
| **Cleaned corpus** | **~78G** (~75.980B chars, **≈18.995B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,874 · construction 431,364 · building_energy 216,412 · structures_civil 172,585 · materials 111,633 · infrastructure 75,654 · architecture 45,285 · standards_protocols 12,066 · controls_bas 11,234 · urban 6,113 · commissioning_fdd 841.

**By license:** open 1,333,174 · public-domain 263,778 · cc-by-sa 1,739 · cc-by 20,370.
<!-- STATS:END -->
