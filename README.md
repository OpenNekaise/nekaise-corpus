...
| **Extracted text** | **~82G** (~79.929B chars, **≈19.982B tokens**) |
| **Cleaned corpus** | **~78G** (~75.975B chars, **≈18.994B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,874 · construction 431,364 · building_energy 216,249 · structures_civil 172,585 · materials 111,623 · infrastructure 75,654 · architecture 45,283 · standards_protocols 12,029 · controls_bas 11,234 · urban 6,113 · commissioning_fdd 841.

**By license:** open 1,333,013 · public-domain 263,730 · cc-by-sa 1,739 · cc-by 20,367.
<!-- STATS:END -->
