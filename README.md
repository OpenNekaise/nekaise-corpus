...
| **Raw originals** | **~636G** (PDF / HTML / source code) |
| **Extracted text** | **~56G** (~54.551B chars, **≈13.638B tokens**) |
| **Cleaned corpus** | **~53G** (~52.228B chars, **≈13.057B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 304,977 · construction 207,479 · building_energy 147,126 · structures_civil 89,710 · materials 60,600 · infrastructure 39,161 · architecture 28,070 · standards_protocols 11,519 · controls_bas 7,216 · urban 5,984 · commissioning_fdd 819.

**By license:** open 679,479 · public-domain 203,139 · cc-by-sa 1,723 · cc-by 18,320.
