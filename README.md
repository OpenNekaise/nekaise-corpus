...
| **Extracted text** | **~33G** (~32.573B chars, **≈8.143B tokens**) |
| **Cleaned corpus** | **~32G** (~31.260B chars, **≈7.815B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 172,772 · building_energy 104,837 · construction 89,004 · structures_civil 44,046 · materials 31,164 · infrastructure 19,043 · architecture 16,062 · standards_protocols 9,892 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 341,344 · public-domain 122,214 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
