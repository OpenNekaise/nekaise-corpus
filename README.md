...
| **Extracted text** | **~76G** (~74.136B chars, **≈18.534B tokens**) |
| **Cleaned corpus** | **~72G** (~70.535B chars, **≈17.634B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 484,092 · construction 383,727 · building_energy 197,069 · structures_civil 154,210 · materials 101,010 · infrastructure 67,748 · architecture 41,198 · standards_protocols 11,552 · controls_bas 11,029 · urban 6,010 · commissioning_fdd 832.

**By license:** open 1,186,045 · public-domain 251,813 · cc-by-sa 1,734 · cc-by 18,885.
<!-- STATS:END -->
