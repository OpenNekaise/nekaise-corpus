...
| **Extracted text** | **~30G** (~29.353B chars, **≈7.338B tokens**) |
| **Cleaned corpus** | **~29G** (~28.256B chars, **≈7.064B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 136,306 · building_energy 93,127 · construction 76,753 · structures_civil 38,238 · materials 27,114 · infrastructure 16,113 · architecture 13,400 · standards_protocols 8,948 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 279,358 · public-domain 107,379 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
