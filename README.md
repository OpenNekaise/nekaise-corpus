...
| **Extracted text** | **~76G** (~74.680B chars, **≈18.670B tokens**) |
| **Cleaned corpus** | **~72G** (~71.044B chars, **≈17.761B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 489,141 · construction 388,418 · building_energy 198,520 · structures_civil 156,126 · materials 101,996 · infrastructure 68,454 · architecture 41,519 · standards_protocols 11,553 · controls_bas 11,029 · urban 6,013 · commissioning_fdd 832.

**By license:** open 1,199,737 · public-domain 253,226 · cc-by-sa 1,734 · cc-by 18,904.
<!-- STATS:END -->
