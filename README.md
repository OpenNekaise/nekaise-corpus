...
| **Extracted text** | **~46G** (~32.796B chars, **≈8.199B tokens**) |
| **Cleaned corpus** | **~31G** (~31.926B chars, **≈7.981B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 85,903 · equipment_systems 71,334 · construction 49,952 · structures_civil 20,727 · materials 17,110 · architecture 12,325 · standards_protocols 11,494 · infrastructure 10,001 · urban 5,982 · controls_bas 4,124 · commissioning_fdd 802.

**By license:** open 88,613 · public-domain 181,248 · cc-by-sa 1,723 · cc-by 18,170.
