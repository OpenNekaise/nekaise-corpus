...
| **Extracted text** | **~82G** (~79.856B chars, **≈19.964B tokens**) |
| **Cleaned corpus** | **~78G** (~75.902B chars, **≈18.976B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,867 · construction 431,358 · building_energy 215,315 · structures_civil 172,585 · materials 111,431 · infrastructure 75,654 · architecture 45,279 · standards_protocols 11,862 · controls_bas 11,211 · urban 6,108 · commissioning_fdd 841.

**By license:** open 1,332,039 · public-domain 263,522 · cc-by-sa 1,737 · cc-by 20,213.
<!-- STATS:END -->
