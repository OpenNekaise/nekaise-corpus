...
| **Extracted text** | **~43G** (~42.832B chars, **≈10.708B tokens**) |
| **Cleaned corpus** | **~42G** (~41.128B chars, **≈10.282B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 223,600 · construction 131,386 · building_energy 125,510 · structures_civil 61,441 · materials 39,892 · infrastructure 26,520 · architecture 23,213 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 472,632 · public-domain 161,471 · cc-by-sa 1,723 · cc-by 18,183.
