...
| **Raw originals** | **~608G** (PDF / HTML / source code) |
| **Extracted text** | **~52G** (~51.061B chars, **≈12.765B tokens**) |
| **Cleaned corpus** | **~50G** (~48.943B chars, **≈12.236B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 276,891 · construction 180,160 · building_energy 139,818 · structures_civil 79,323 · materials 53,459 · infrastructure 34,797 · architecture 25,754 · standards_protocols 11,514 · urban 5,983 · controls_bas 5,005 · commissioning_fdd 819.

**By license:** open 598,449 · public-domain 195,086 · cc-by-sa 1,723 · cc-by 18,265.
