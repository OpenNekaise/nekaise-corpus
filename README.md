...
| **Extracted text** | **~55G** (~54.188B chars, **≈13.547B tokens**) |
| **Cleaned corpus** | **~53G** (~51.887B chars, **≈12.972B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 301,805 · construction 204,460 · building_energy 146,334 · structures_civil 88,683 · materials 60,016 · infrastructure 38,687 · architecture 27,859 · standards_protocols 11,519 · controls_bas 7,030 · urban 5,984 · commissioning_fdd 819.

**By license:** open 670,958 · public-domain 202,204 · cc-by-sa 1,723 · cc-by 18,311.
