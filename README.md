...
| **Extracted text** | **~32G** (~31.345B chars, **≈7.836B tokens**) |
| **Cleaned corpus** | **~31G** (~30.114B chars, **≈7.529B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 159,293 · building_energy 100,289 · construction 84,756 · structures_civil 42,042 · materials 29,761 · infrastructure 17,989 · architecture 14,888 · standards_protocols 9,507 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 319,355 · public-domain 115,908 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
