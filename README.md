...
| **Extracted text** | **~81G** (~79.417B chars, **≈19.854B tokens**) |
| **Cleaned corpus** | **~77G** (~75.476B chars, **≈18.869B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 533,568 · construction 429,800 · building_energy 210,650 · structures_civil 171,930 · materials 111,058 · infrastructure 75,209 · architecture 44,690 · standards_protocols 11,562 · controls_bas 11,058 · urban 6,014 · commissioning_fdd 836.

**By license:** open 1,323,428 · public-domain 262,181 · cc-by-sa 1,736 · cc-by 19,030.
<!-- STATS:END -->
