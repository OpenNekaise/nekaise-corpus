...
| **Extracted text** | **~46G** (~32.654B chars, **≈8.163B tokens**) |
| **Cleaned corpus** | **~31G** (~31.788B chars, **≈7.947B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 85,734 · equipment_systems 70,735 · construction 49,617 · structures_civil 20,603 · materials 17,054 · architecture 12,288 · standards_protocols 11,509 · infrastructure 9,959 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 88,698 · public-domain 179,834 · cc-by-sa 1,723 · cc-by 18,183.
