...
| **Extracted text** | **~68G** (~67.071B chars, **≈16.768B tokens**) |
| **Cleaned corpus** | **~65G** (~63.936B chars, **≈15.984B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 418,335 · construction 319,289 · building_energy 178,601 · structures_civil 130,734 · materials 86,902 · infrastructure 57,451 · architecture 36,777 · standards_protocols 11,538 · controls_bas 10,988 · urban 6,005 · commissioning_fdd 830.

**By license:** open 1,003,857 · public-domain 233,173 · cc-by-sa 1,732 · cc-by 18,688.
