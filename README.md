...
| **Extracted text** | **~41G** (~40.414B chars, **≈10.103B tokens**) |
| **Cleaned corpus** | **~39G** (~38.792B chars, **≈9.698B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 210,749 · building_energy 121,063 · construction 120,584 · structures_civil 56,289 · materials 37,319 · infrastructure 24,679 · architecture 21,943 · standards_protocols 10,878 · urban 5,886 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 422,835 · public-domain 151,036 · cc-by-sa 1,723 · cc-by 37,570.
