...
| **Extracted text** | **~32G** (~31.489B chars, **≈7.872B tokens**) |
| **Cleaned corpus** | **~31G** (~30.249B chars, **≈7.562B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 160,944 · building_energy 100,827 · construction 85,305 · structures_civil 42,291 · materials 29,937 · infrastructure 18,108 · architecture 15,017 · standards_protocols 9,550 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 322,185 · public-domain 116,532 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
