...
| **Extracted text** | **~46G** (~45.404B chars, **≈11.351B tokens**) |
| **Cleaned corpus** | **~44G** (~43.608B chars, **≈10.902B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,925 · construction 141,283 · building_energy 129,045 · structures_civil 65,393 · materials 41,915 · infrastructure 28,042 · architecture 24,271 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 176,960 · cc-by-sa 1,723 · cc-by 18,183.
