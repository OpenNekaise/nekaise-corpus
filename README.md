...
| **Extracted text** | **~30G** (~29.714B chars, **≈7.429B tokens**) |
| **Cleaned corpus** | **~29G** (~28.594B chars, **≈7.148B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 140,359 · building_energy 94,429 · construction 78,479 · structures_civil 38,964 · materials 27,604 · infrastructure 16,467 · architecture 13,653 · standards_protocols 8,982 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 286,871 · public-domain 108,804 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
