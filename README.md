...
| **Extracted text** | **~65G** (~63.333B chars, **≈15.833B tokens**) |
| **Cleaned corpus** | **~61G** (~60.442B chars, **≈15.111B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 384,295 · construction 285,181 · building_energy 168,898 · structures_civil 117,990 · materials 78,933 · infrastructure 52,132 · architecture 34,248 · standards_protocols 11,529 · controls_bas 10,040 · urban 6,002 · commissioning_fdd 826.

**By license:** open 905,076 · public-domain 224,661 · cc-by-sa 1,732 · cc-by 18,605.
