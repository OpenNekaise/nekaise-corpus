...
| **Raw originals** | **~679G** (PDF / HTML / source code) |
| **Extracted text** | **~65G** (~63.737B chars, **≈15.934B tokens**) |
| **Cleaned corpus** | **~62G** (~60.820B chars, **≈15.205B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 388,144 · construction 289,117 · building_energy 169,963 · structures_civil 119,450 · materials 79,804 · infrastructure 52,756 · architecture 34,540 · standards_protocols 11,529 · controls_bas 10,105 · urban 6,002 · commissioning_fdd 826.

**By license:** open 916,364 · public-domain 225,531 · cc-by-sa 1,732 · cc-by 18,609.
