...
| **Extracted text** | **~46G** (~45.277B chars, **≈11.319B tokens**) |
| **Cleaned corpus** | **~44G** (~43.484B chars, **≈10.871B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,425 · construction 141,038 · building_energy 128,901 · structures_civil 65,269 · materials 41,871 · infrastructure 28,005 · architecture 24,228 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 175,823 · cc-by-sa 1,723 · cc-by 18,183.
