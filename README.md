...
| **Extracted text** | **~54G** (~52.855B chars, **≈13.214B tokens**) |
| **Cleaned corpus** | **~51G** (~50.632B chars, **≈12.658B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 291,227 · construction 193,912 · building_energy 143,488 · structures_civil 84,722 · materials 57,205 · infrastructure 37,092 · architecture 26,953 · standards_protocols 11,516 · controls_bas 6,109 · urban 5,983 · commissioning_fdd 819.

**By license:** open 639,832 · public-domain 199,178 · cc-by-sa 1,723 · cc-by 18,293.
