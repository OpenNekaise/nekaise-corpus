...
|---|---|
| **Documents** | **568,821** |
| **Raw originals** | **~525G** (PDF / HTML / source code) |
| **Extracted text** | **~38G** (~37.895B chars, **≈9.474B tokens**) |
| **Cleaned corpus** | **~37G** (~36.376B chars, **≈9.094B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 198,378 · building_energy 115,249 · construction 106,290 · structures_civil 51,663 · materials 34,934 · infrastructure 22,510 · architecture 19,406 · standards_protocols 10,861 · urban 5,756 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 389,235 · public-domain 143,388 · cc-by-sa 1,723 · cc-by 34,470 · proprietary-internal 5.
