...
| **Extracted text** | **~54G** (~53.395B chars, **≈13.349B tokens**) |
| **Cleaned corpus** | **~52G** (~51.141B chars, **≈12.785B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 295,660 · construction 198,142 · building_energy 144,610 · structures_civil 86,320 · materials 58,245 · infrastructure 37,789 · architecture 27,352 · standards_protocols 11,516 · controls_bas 6,464 · urban 5,984 · commissioning_fdd 819.

**By license:** open 652,491 · public-domain 200,384 · cc-by-sa 1,723 · cc-by 18,303.
