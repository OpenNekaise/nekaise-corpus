...
| **Extracted text** | **~81G** (~79.402B chars, **≈19.850B tokens**) |
| **Cleaned corpus** | **~77G** (~75.462B chars, **≈18.866B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 533,419 · construction 429,693 · building_energy 210,612 · structures_civil 171,872 · materials 111,025 · infrastructure 75,177 · architecture 44,681 · standards_protocols 11,562 · controls_bas 11,058 · urban 6,014 · commissioning_fdd 836.

**By license:** open 1,323,026 · public-domain 262,158 · cc-by-sa 1,736 · cc-by 19,029.
<!-- STATS:END -->
