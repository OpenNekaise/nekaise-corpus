...
| **Extracted text** | **~74G** (~72.444B chars, **≈18.111B tokens**) |
| **Cleaned corpus** | **~70G** (~68.955B chars, **≈17.239B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 468,237 · construction 368,315 · building_energy 192,794 · structures_civil 148,412 · materials 97,804 · infrastructure 65,494 · architecture 40,173 · standards_protocols 11,550 · controls_bas 11,023 · urban 6,009 · commissioning_fdd 831.

**By license:** open 1,142,671 · public-domain 247,393 · cc-by-sa 1,734 · cc-by 18,844.
<!-- STATS:END -->
