...
| **Raw originals** | **~650G** (PDF / HTML / source code) |
| **Extracted text** | **~59G** (~57.397B chars, **≈14.349B tokens**) |
| **Cleaned corpus** | **~56G** (~54.896B chars, **≈13.724B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 328,666 · construction 231,735 · building_energy 153,491 · structures_civil 98,442 · materials 66,668 · infrastructure 42,782 · architecture 29,778 · standards_protocols 11,523 · controls_bas 8,326 · urban 5,997 · commissioning_fdd 819.

**By license:** open 748,209 · public-domain 209,864 · cc-by-sa 1,732 · cc-by 18,422.
