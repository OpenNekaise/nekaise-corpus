...
| **Extracted text** | **~76G** (~74.094B chars, **≈18.523B tokens**) |
| **Cleaned corpus** | **~72G** (~70.496B chars, **≈17.624B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 483,727 · construction 383,374 · building_energy 196,946 · structures_civil 154,074 · materials 100,934 · infrastructure 67,705 · architecture 41,169 · standards_protocols 11,552 · controls_bas 11,029 · urban 6,010 · commissioning_fdd 832.

**By license:** open 1,185,064 · public-domain 251,669 · cc-by-sa 1,734 · cc-by 18,885.
<!-- STATS:END -->
