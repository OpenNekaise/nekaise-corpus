...
| **Extracted text** | **~34G** (~33.343B chars, **≈8.336B tokens**) |
| **Cleaned corpus** | **~32G** (~31.982B chars, **≈7.995B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 180,551 · building_energy 107,440 · construction 91,610 · structures_civil 45,110 · materials 31,910 · infrastructure 19,633 · architecture 16,829 · standards_protocols 10,194 · controls_bas 3,395 · urban 3,032 · commissioning_fdd 374.

**By license:** open 353,440 · public-domain 126,574 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
