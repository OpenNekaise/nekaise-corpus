...
| **Extracted text** | **~33G** (~33.042B chars, **≈8.261B tokens**) |
| **Cleaned corpus** | **~32G** (~31.701B chars, **≈7.925B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 177,198 · building_energy 106,387 · construction 90,448 · structures_civil 44,669 · materials 31,586 · infrastructure 19,393 · architecture 16,566 · standards_protocols 10,091 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 348,321 · public-domain 124,755 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
