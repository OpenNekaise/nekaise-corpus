...
| **Extracted text** | **~33G** (~32.594B chars, **≈8.148B tokens**) |
| **Cleaned corpus** | **~32G** (~31.280B chars, **≈7.820B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 173,009 · building_energy 104,905 · construction 89,093 · structures_civil 44,072 · materials 31,191 · infrastructure 19,067 · architecture 16,102 · standards_protocols 9,896 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 341,759 · public-domain 122,314 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
