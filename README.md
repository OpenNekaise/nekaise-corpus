...
| **Extracted text** | **~63G** (~61.443B chars, **≈15.361B tokens**) |
| **Cleaned corpus** | **~60G** (~58.679B chars, **≈14.670B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 366,427 · construction 267,347 · building_energy 163,776 · structures_civil 111,402 · materials 74,812 · infrastructure 48,694 · architecture 32,766 · standards_protocols 11,527 · controls_bas 9,664 · urban 5,999 · commissioning_fdd 824.

**By license:** open 852,912 · public-domain 220,055 · cc-by-sa 1,732 · cc-by 18,539.
