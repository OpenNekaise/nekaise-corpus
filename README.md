...
| **Extracted text** | **~69G** (~67.913B chars, **≈16.978B tokens**) |
| **Cleaned corpus** | **~66G** (~64.722B chars, **≈16.180B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 425,800 · construction 326,909 · building_energy 180,847 · structures_civil 133,606 · materials 88,743 · infrastructure 58,678 · architecture 37,343 · standards_protocols 11,542 · controls_bas 10,990 · urban 6,005 · commissioning_fdd 830.

**By license:** open 1,025,712 · public-domain 235,147 · cc-by-sa 1,732 · cc-by 18,702.
