...
| **Extracted text** | **~32G** (~31.700B chars, **≈7.925B tokens**) |
| **Cleaned corpus** | **~31G** (~30.446B chars, **≈7.612B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 163,189 · building_energy 101,601 · construction 85,977 · structures_civil 42,614 · materials 30,191 · infrastructure 18,280 · architecture 15,202 · standards_protocols 9,610 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 325,768 · public-domain 117,634 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
