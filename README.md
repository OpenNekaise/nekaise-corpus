...
| **Extracted text** | **~54G** (~53.328B chars, **≈13.332B tokens**) |
| **Cleaned corpus** | **~52G** (~51.078B chars, **≈12.769B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 295,073 · construction 197,573 · building_energy 144,465 · structures_civil 86,104 · materials 58,132 · infrastructure 37,689 · architecture 27,300 · standards_protocols 11,516 · controls_bas 6,462 · urban 5,984 · commissioning_fdd 819.

**By license:** open 650,852 · public-domain 200,240 · cc-by-sa 1,723 · cc-by 18,302.
