...
| **Extracted text** | **~47G** (~32.988B chars, **≈8.247B tokens**) |
| **Cleaned corpus** | **~31G** (~32.112B chars, **≈8.028B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 86,151 · equipment_systems 72,065 · construction 50,357 · structures_civil 20,872 · materials 17,174 · architecture 12,377 · standards_protocols 11,501 · infrastructure 10,057 · urban 5,982 · controls_bas 4,125 · commissioning_fdd 804.

**By license:** open 88,620 · public-domain 182,943 · cc-by-sa 1,723 · cc-by 18,179.
