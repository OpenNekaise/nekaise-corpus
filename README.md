...
| **Extracted text** | **~40G** (~39.950B chars, **≈9.987B tokens**) |
| **Cleaned corpus** | **~39G** (~38.352B chars, **≈9.588B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 207,680 · building_energy 120,250 · construction 117,726 · structures_civil 55,148 · materials 36,713 · infrastructure 24,222 · architecture 21,719 · standards_protocols 10,878 · urban 5,886 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 415,257 · public-domain 149,446 · cc-by-sa 1,723 · cc-by 37,570.
