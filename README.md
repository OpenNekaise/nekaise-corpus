...
| **Extracted text** | **~54G** (~53.294B chars, **≈13.324B tokens**) |
| **Cleaned corpus** | **~52G** (~51.046B chars, **≈12.762B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 294,796 · construction 197,292 · building_energy 144,386 · structures_civil 86,000 · materials 58,066 · infrastructure 37,644 · architecture 27,279 · standards_protocols 11,516 · controls_bas 6,462 · urban 5,984 · commissioning_fdd 819.

**By license:** open 650,055 · public-domain 200,164 · cc-by-sa 1,723 · cc-by 18,302.
