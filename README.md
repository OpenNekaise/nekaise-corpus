...
| **Extracted text** | **~68G** (~67.147B chars, **≈16.787B tokens**) |
| **Cleaned corpus** | **~65G** (~64.007B chars, **≈16.002B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 418,964 · construction 319,988 · building_energy 178,808 · structures_civil 131,021 · materials 87,067 · infrastructure 57,561 · architecture 36,824 · standards_protocols 11,540 · controls_bas 10,988 · urban 6,005 · commissioning_fdd 830.

**By license:** open 1,005,854 · public-domain 233,321 · cc-by-sa 1,732 · cc-by 18,689.
