...
| **Extracted text** | **~30G** (~29.618B chars, **≈7.405B tokens**) |
| **Cleaned corpus** | **~29G** (~28.505B chars, **≈7.126B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 139,253 · building_energy 94,140 · construction 78,046 · structures_civil 38,772 · materials 27,486 · infrastructure 16,391 · architecture 13,581 · standards_protocols 8,978 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 284,977 · public-domain 108,408 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
