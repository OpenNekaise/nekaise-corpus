...
| **Extracted text** | **~33G** (~32.780B chars, **≈8.195B tokens**) |
| **Cleaned corpus** | **~32G** (~31.456B chars, **≈7.864B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 174,638 · building_energy 105,524 · construction 89,674 · structures_civil 44,308 · materials 31,344 · infrastructure 19,193 · architecture 16,261 · standards_protocols 9,975 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 344,339 · public-domain 123,316 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
