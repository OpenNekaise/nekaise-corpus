...
| **Extracted text** | **~24G** (~23.955B chars, **≈5.989B tokens**) |
| **Cleaned corpus** | **~23G** (~23.196B chars, **≈5.799B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 81,574 · building_energy 72,767 · construction 53,382 · structures_civil 27,281 · materials 20,038 · infrastructure 11,341 · architecture 8,878 · standards_protocols 7,911 · urban 2,973 · controls_bas 2,930 · commissioning_fdd 374.

**By license:** open 172,648 · public-domain 87,269 · cc-by-sa 1,659 · cc-by 27,868 · proprietary-internal 5.
