...
| **Extracted text** | **~66G** (~64.747B chars, **≈16.187B tokens**) |
| **Cleaned corpus** | **~63G** (~61.763B chars, **≈15.441B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 397,432 · construction 298,466 · building_energy 172,586 · structures_civil 122,932 · materials 81,881 · infrastructure 54,182 · architecture 35,242 · standards_protocols 11,531 · controls_bas 10,348 · urban 6,002 · commissioning_fdd 826.

**By license:** open 943,533 · public-domain 227,531 · cc-by-sa 1,732 · cc-by 18,632.
