...
| **Extracted text** | **~65G** (~63.859B chars, **≈15.965B tokens**) |
| **Cleaned corpus** | **~62G** (~60.933B chars, **≈15.233B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 389,266 · construction 290,258 · building_energy 170,270 · structures_civil 119,873 · materials 80,068 · infrastructure 52,928 · architecture 34,620 · standards_protocols 11,531 · controls_bas 10,109 · urban 6,002 · commissioning_fdd 826.

**By license:** open 919,544 · public-domain 225,861 · cc-by-sa 1,732 · cc-by 18,614.
