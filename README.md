...
| **Extracted text** | **~78G** (~75.982B chars, **≈18.995B tokens**) |
| **Cleaned corpus** | **~74G** (~72.262B chars, **≈18.066B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 501,117 · construction 399,900 · building_energy 201,808 · structures_civil 160,441 · materials 104,394 · infrastructure 70,246 · architecture 42,288 · standards_protocols 11,555 · controls_bas 11,031 · urban 6,013 · commissioning_fdd 834.

**By license:** open 1,232,641 · public-domain 256,313 · cc-by-sa 1,734 · cc-by 18,939.
<!-- STATS:END -->
