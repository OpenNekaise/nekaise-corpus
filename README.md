...
| **Extracted text** | **~46G** (~45.097B chars, **≈11.274B tokens**) |
| **Cleaned corpus** | **~44G** (~43.309B chars, **≈10.827B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 234,764 · construction 140,701 · building_energy 128,725 · structures_civil 65,110 · materials 41,800 · infrastructure 27,950 · architecture 24,177 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,455 · public-domain 174,313 · cc-by-sa 1,723 · cc-by 18,183.
