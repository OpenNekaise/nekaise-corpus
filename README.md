...
| **Extracted text** | **~46G** (~32.713B chars, **≈8.178B tokens**) |
| **Cleaned corpus** | **~31G** (~31.846B chars, **≈7.961B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 85,785 · equipment_systems 70,967 · construction 49,742 · structures_civil 20,652 · materials 17,075 · architecture 12,302 · standards_protocols 11,509 · infrastructure 9,965 · urban 5,982 · controls_bas 4,149 · commissioning_fdd 823.

**By license:** open 88,708 · public-domain 180,332 · cc-by-sa 1,723 · cc-by 18,188.
