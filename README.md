...
| **Extracted text** | **~54G** (~53.091B chars, **≈13.273B tokens**) |
| **Cleaned corpus** | **~52G** (~50.855B chars, **≈12.714B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 293,090 · construction 195,636 · building_energy 143,969 · structures_civil 85,371 · materials 57,571 · infrastructure 37,359 · architecture 27,125 · standards_protocols 11,516 · controls_bas 6,311 · urban 5,984 · commissioning_fdd 819.

**By license:** open 645,066 · public-domain 199,661 · cc-by-sa 1,723 · cc-by 18,301.
