...
|---|---|
| **Documents** | **77,518** |
| **Raw originals** | **~231G** (PDF / HTML / source code) |
| **Extracted text** | **~11G** (~10.486B chars, **≈2.621B tokens**) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 29,154 · equipment_systems 16,732 · construction 10,952 · structures_civil 7,007 · materials 3,724 · infrastructure 2,818 · architecture 2,674 · standards_protocols 1,831 · controls_bas 1,290 · urban 967 · commissioning_fdd 369.

**By license:** open 25,130 · public-domain 41,642 · cc-by-sa 1,605 · cc-by 9,136 · proprietary-internal 5.
