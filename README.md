...
| **Extracted text** | **~67G** (~65.433B chars, **≈16.358B tokens**) |
| **Cleaned corpus** | **~63G** (~62.405B chars, **≈15.601B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 403,447 · construction 304,489 · building_energy 174,335 · structures_civil 125,161 · materials 83,285 · infrastructure 55,132 · architecture 35,676 · standards_protocols 11,533 · controls_bas 10,668 · urban 6,003 · commissioning_fdd 826.

**By license:** open 960,987 · public-domain 229,196 · cc-by-sa 1,732 · cc-by 18,640.
