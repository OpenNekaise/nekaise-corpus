...
| **Extracted text** | **~67G** (~65.632B chars, **≈16.408B tokens**) |
| **Cleaned corpus** | **~64G** (~62.591B chars, **≈15.648B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 405,354 · construction 306,253 · building_energy 174,876 · structures_civil 125,859 · materials 83,692 · infrastructure 55,432 · architecture 35,800 · standards_protocols 11,533 · controls_bas 10,702 · urban 6,003 · commissioning_fdd 827.

**By license:** open 966,313 · public-domain 229,644 · cc-by-sa 1,732 · cc-by 18,642.
