...
| **Extracted text** | **~46G** (~45.268B chars, **≈11.317B tokens**) |
| **Cleaned corpus** | **~44G** (~43.475B chars, **≈10.869B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,389 · construction 141,021 · building_energy 128,895 · structures_civil 65,258 · materials 41,867 · infrastructure 28,004 · architecture 24,226 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 175,746 · cc-by-sa 1,723 · cc-by 18,183.
