...
| **Extracted text** | **~41G** (~40.474B chars, **≈10.118B tokens**) |
| **Cleaned corpus** | **~39G** (~38.849B chars, **≈9.712B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 211,187 · building_energy 121,190 · construction 121,047 · structures_civil 56,447 · materials 37,399 · infrastructure 24,734 · architecture 21,978 · standards_protocols 10,878 · urban 5,886 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 424,032 · public-domain 151,195 · cc-by-sa 1,723 · cc-by 37,570.
