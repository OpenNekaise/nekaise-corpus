...
|---|---|
| **Documents** | **429,816** |
| **Raw originals** | **~460G** (PDF / HTML / source code) |
| **Extracted text** | **~30G** (~29.879B chars, **≈7.470B tokens**) |
| **Cleaned corpus** | **~29G** (~28.748B chars, **≈7.187B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 142,175 · building_energy 95,007 · construction 79,225 · structures_civil 39,312 · materials 27,831 · infrastructure 16,639 · architecture 13,796 · standards_protocols 9,029 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 290,303 · public-domain 109,449 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
