...
| **Extracted text** | **~26G** (~25.642B chars, **≈6.410B tokens**) |
| **Cleaned corpus** | **~25G** (~24.787B chars, **≈6.197B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 96,236 · building_energy 79,627 · construction 60,220 · structures_civil 30,456 · materials 22,143 · infrastructure 12,727 · architecture 10,141 · standards_protocols 8,110 · controls_bas 3,091 · urban 3,032 · commissioning_fdd 374.

**By license:** open 202,855 · public-domain 93,238 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
