...
| **Extracted text** | **~25G** (~24.960B chars, **≈6.240B tokens**) |
| **Cleaned corpus** | **~24G** (~24.149B chars, **≈6.037B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 89,307 · building_energy 76,804 · construction 57,004 · structures_civil 28,923 · materials 21,142 · infrastructure 12,071 · architecture 9,575 · standards_protocols 8,002 · urban 3,032 · controls_bas 2,972 · commissioning_fdd 374.

**By license:** open 188,386 · public-domain 90,756 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
