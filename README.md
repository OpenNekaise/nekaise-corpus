...
| **Extracted text** | **~69G** (~67.567B chars, **≈16.892B tokens**) |
| **Cleaned corpus** | **~65G** (~64.399B chars, **≈16.100B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 422,653 · construction 323,881 · building_energy 179,956 · structures_civil 132,406 · materials 88,015 · infrastructure 58,148 · architecture 37,100 · standards_protocols 11,540 · controls_bas 10,989 · urban 6,005 · commissioning_fdd 830.

**By license:** open 1,016,768 · public-domain 234,331 · cc-by-sa 1,732 · cc-by 18,692.
