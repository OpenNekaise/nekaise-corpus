...
| **Extracted text** | **~33G** (~32.584B chars, **≈8.146B tokens**) |
| **Cleaned corpus** | **~32G** (~31.271B chars, **≈7.818B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 172,904 · building_energy 104,878 · construction 89,055 · structures_civil 44,060 · materials 31,176 · infrastructure 19,059 · architecture 16,071 · standards_protocols 9,895 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 341,557 · public-domain 122,279 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
