...
| **Extracted text** | **~49G** (~47.720B chars, **≈11.930B tokens**) |
| **Cleaned corpus** | **~46G** (~45.803B chars, **≈11.451B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 251,969 · construction 152,974 · building_energy 132,688 · structures_civil 69,011 · materials 45,776 · infrastructure 30,350 · architecture 23,473 · standards_protocols 11,502 · urban 5,983 · controls_bas 4,432 · commissioning_fdd 810.

**By license:** open 521,060 · public-domain 187,982 · cc-by-sa 1,723 · cc-by 18,203.
