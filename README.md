...
| **Extracted text** | **~46G** (~32.740B chars, **≈8.185B tokens**) |
| **Cleaned corpus** | **~31G** (~31.872B chars, **≈7.968B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 85,817 · equipment_systems 71,068 · construction 49,785 · structures_civil 20,671 · materials 17,084 · architecture 12,310 · standards_protocols 11,509 · infrastructure 9,979 · urban 5,982 · controls_bas 4,149 · commissioning_fdd 832.

**By license:** open 88,716 · public-domain 180,557 · cc-by-sa 1,723 · cc-by 18,190.
