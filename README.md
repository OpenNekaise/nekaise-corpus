...
| **Extracted text** | **~82G** (~79.768B chars, **≈19.942B tokens**) |
| **Cleaned corpus** | **~77G** (~75.814B chars, **≈18.954B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,807 · construction 431,344 · building_energy 213,439 · structures_civil 172,585 · materials 111,388 · infrastructure 75,654 · architecture 45,275 · standards_protocols 11,571 · controls_bas 11,186 · urban 6,097 · commissioning_fdd 841.

**By license:** open 1,330,403 · public-domain 263,025 · cc-by-sa 1,736 · cc-by 20,023.
<!-- STATS:END -->
