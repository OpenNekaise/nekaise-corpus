...
| **Raw originals** | **~640G** (PDF / HTML / source code) |
| **Extracted text** | **~57G** (~55.362B chars, **≈13.841B tokens**) |
| **Cleaned corpus** | **~54G** (~52.989B chars, **≈13.247B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 311,854 · construction 214,148 · building_energy 148,850 · structures_civil 92,247 · materials 62,505 · infrastructure 40,274 · architecture 28,548 · standards_protocols 11,519 · controls_bas 7,558 · urban 5,996 · commissioning_fdd 819.

**By license:** open 699,250 · public-domain 204,961 · cc-by-sa 1,732 · cc-by 18,375.
