...
| **Extracted text** | **~46G** (~45.287B chars, **≈11.322B tokens**) |
| **Cleaned corpus** | **~44G** (~43.494B chars, **≈10.873B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,469 · construction 141,056 · building_energy 128,909 · structures_civil 65,277 · materials 41,875 · infrastructure 28,007 · architecture 24,230 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 175,909 · cc-by-sa 1,723 · cc-by 18,183.
