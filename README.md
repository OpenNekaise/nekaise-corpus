...
|---|---|
| **Documents** | **88,371** |
| **Raw originals** | **~259G** (PDF / HTML / source code) |
| **Extracted text** | **~12G** (~11.706B chars, **≈2.926B tokens**) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 34,257 · equipment_systems 18,705 · construction 12,523 · structures_civil 7,593 · materials 4,176 · infrastructure 3,248 · architecture 2,878 · standards_protocols 2,013 · controls_bas 1,380 · urban 1,225 · commissioning_fdd 373.

**By license:** open 29,643 · public-domain 46,165 · cc-by-sa 1,607 · cc-by 10,951 · proprietary-internal 5.
