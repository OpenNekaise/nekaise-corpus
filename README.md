...
| **Extracted text** | **~54G** (~53.243B chars, **≈13.311B tokens**) |
| **Cleaned corpus** | **~52G** (~50.999B chars, **≈12.750B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 294,355 · construction 196,859 · building_energy 144,273 · structures_civil 85,843 · materials 57,983 · infrastructure 37,562 · architecture 27,244 · standards_protocols 11,516 · controls_bas 6,462 · urban 5,984 · commissioning_fdd 819.

**By license:** open 648,856 · public-domain 200,019 · cc-by-sa 1,723 · cc-by 18,302.
