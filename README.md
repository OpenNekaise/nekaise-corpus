...
| **Extracted text** | **~55G** (~54.272B chars, **≈13.568B tokens**) |
| **Cleaned corpus** | **~53G** (~51.966B chars, **≈12.992B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 302,493 · construction 205,230 · building_energy 146,505 · structures_civil 88,926 · materials 60,159 · infrastructure 38,815 · architecture 27,912 · standards_protocols 11,519 · controls_bas 7,058 · urban 5,984 · commissioning_fdd 819.

**By license:** open 672,987 · public-domain 202,399 · cc-by-sa 1,723 · cc-by 18,311.
