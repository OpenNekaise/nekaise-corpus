...
| **Extracted text** | **~78G** (~76.340B chars, **≈19.085B tokens**) |
| **Cleaned corpus** | **~74G** (~72.597B chars, **≈18.149B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 504,312 · construction 403,112 · building_energy 202,770 · structures_civil 161,667 · materials 105,033 · infrastructure 70,732 · architecture 42,547 · standards_protocols 11,555 · controls_bas 11,031 · urban 6,014 · commissioning_fdd 834.

**By license:** open 1,241,950 · public-domain 256,958 · cc-by-sa 1,734 · cc-by 18,965.
<!-- STATS:END -->
