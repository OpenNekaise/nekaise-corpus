...
| **Raw originals** | **~609G** (PDF / HTML / source code) |
| **Extracted text** | **~52G** (~51.081B chars, **≈12.770B tokens**) |
| **Cleaned corpus** | **~50G** (~48.962B chars, **≈12.241B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 277,067 · construction 180,311 · building_energy 139,853 · structures_civil 79,382 · materials 53,490 · infrastructure 34,823 · architecture 25,770 · standards_protocols 11,514 · urban 5,983 · controls_bas 5,021 · commissioning_fdd 819.

**By license:** open 598,909 · public-domain 195,136 · cc-by-sa 1,723 · cc-by 18,265.
