...
| **Extracted text** | **~66G** (~64.554B chars, **≈16.138B tokens**) |
| **Cleaned corpus** | **~63G** (~61.583B chars, **≈15.396B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 395,660 · construction 296,657 · building_energy 172,081 · structures_civil 122,235 · materials 81,495 · infrastructure 53,896 · architecture 35,106 · standards_protocols 11,531 · controls_bas 10,348 · urban 6,002 · commissioning_fdd 826.

**By license:** open 938,346 · public-domain 227,135 · cc-by-sa 1,732 · cc-by 18,624.
