...
| **Extracted text** | **~60G** (~58.724B chars, **≈14.681B tokens**) |
| **Cleaned corpus** | **~57G** (~56.139B chars, **≈14.035B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 340,322 · construction 242,956 · building_energy 156,743 · structures_civil 102,656 · materials 69,022 · infrastructure 44,543 · architecture 30,597 · standards_protocols 11,523 · controls_bas 8,848 · urban 5,999 · commissioning_fdd 821.

**By license:** open 780,607 · public-domain 213,226 · cc-by-sa 1,732 · cc-by 18,465.
