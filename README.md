...
| **Extracted text** | **~47G** (~46.639B chars, **≈11.660B tokens**) |
| **Cleaned corpus** | **~45G** (~44.781B chars, **≈11.195B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 243,916 · construction 144,909 · building_energy 130,529 · structures_civil 66,083 · materials 43,477 · infrastructure 29,077 · architecture 22,539 · standards_protocols 11,501 · urban 5,983 · controls_bas 4,228 · commissioning_fdd 804.

**By license:** open 497,624 · public-domain 185,510 · cc-by-sa 1,723 · cc-by 18,189.
