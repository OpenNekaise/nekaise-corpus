...
| **Extracted text** | **~69G** (~67.286B chars, **≈16.821B tokens**) |
| **Cleaned corpus** | **~65G** (~64.136B chars, **≈16.034B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 420,204 · construction 321,287 · building_energy 179,200 · structures_civil 131,449 · materials 87,351 · infrastructure 57,756 · architecture 36,911 · standards_protocols 11,540 · controls_bas 10,989 · urban 6,005 · commissioning_fdd 830.

**By license:** open 1,009,445 · public-domain 233,656 · cc-by-sa 1,732 · cc-by 18,689.
