...
| **Extracted text** | **~79G** (~77.546B chars, **≈19.387B tokens**) |
| **Cleaned corpus** | **~75G** (~73.727B chars, **≈18.432B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 515,484 · construction 413,769 · building_energy 205,826 · structures_civil 165,716 · materials 107,303 · infrastructure 72,382 · architecture 43,344 · standards_protocols 11,561 · controls_bas 11,048 · urban 6,014 · commissioning_fdd 835.

**By license:** open 1,273,603 · public-domain 258,955 · cc-by-sa 1,735 · cc-by 18,989.
<!-- STATS:END -->
