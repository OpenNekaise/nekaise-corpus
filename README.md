...
| **Extracted text** | **~69G** (~67.714B chars, **≈16.929B tokens**) |
| **Cleaned corpus** | **~66G** (~64.536B chars, **≈16.134B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 424,027 · construction 325,179 · building_energy 180,354 · structures_civil 132,877 · materials 88,330 · infrastructure 58,355 · architecture 37,211 · standards_protocols 11,540 · controls_bas 10,990 · urban 6,005 · commissioning_fdd 830.

**By license:** open 1,020,556 · public-domain 234,717 · cc-by-sa 1,732 · cc-by 18,693.
