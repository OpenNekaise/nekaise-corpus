...
| **Extracted text** | **~47G** (~33.029B chars, **≈8.257B tokens**) |
| **Cleaned corpus** | **~31G** (~32.151B chars, **≈8.038B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 86,209 · equipment_systems 72,215 · construction 50,445 · structures_civil 20,906 · materials 17,187 · architecture 12,385 · standards_protocols 11,501 · infrastructure 10,069 · urban 5,982 · controls_bas 4,125 · commissioning_fdd 804.

**By license:** open 88,621 · public-domain 183,304 · cc-by-sa 1,723 · cc-by 18,180.
