...
| **Extracted text** | **~46G** (~45.187B chars, **≈11.297B tokens**) |
| **Cleaned corpus** | **~44G** (~43.397B chars, **≈10.849B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,108 · construction 140,859 · building_energy 128,822 · structures_civil 65,189 · materials 41,834 · infrastructure 27,983 · architecture 24,203 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,455 · public-domain 175,084 · cc-by-sa 1,723 · cc-by 18,183.
