...
| **Raw originals** | **~606G** (PDF / HTML / source code) |
| **Extracted text** | **~52G** (~50.772B chars, **≈12.693B tokens**) |
| **Cleaned corpus** | **~49G** (~48.673B chars, **≈12.168B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 274,530 · construction 177,923 · building_energy 139,214 · structures_civil 78,460 · materials 53,012 · infrastructure 34,437 · architecture 25,572 · standards_protocols 11,514 · urban 5,983 · controls_bas 4,844 · commissioning_fdd 816.

**By license:** open 591,904 · public-domain 194,417 · cc-by-sa 1,723 · cc-by 18,261.
