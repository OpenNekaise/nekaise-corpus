...
| **Extracted text** | **~65G** (~63.604B chars, **≈15.901B tokens**) |
| **Cleaned corpus** | **~62G** (~60.696B chars, **≈15.174B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 386,797 · construction 287,863 · building_energy 169,611 · structures_civil 118,987 · materials 79,490 · infrastructure 52,567 · architecture 34,452 · standards_protocols 11,529 · controls_bas 10,093 · urban 6,002 · commissioning_fdd 826.

**By license:** open 912,623 · public-domain 225,254 · cc-by-sa 1,732 · cc-by 18,608.
