...
| **Extracted text** | **~54G** (~52.872B chars, **≈13.218B tokens**) |
| **Cleaned corpus** | **~51G** (~50.649B chars, **≈12.662B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 291,361 · construction 194,060 · building_energy 143,537 · structures_civil 84,770 · materials 57,226 · infrastructure 37,119 · architecture 26,969 · standards_protocols 11,516 · controls_bas 6,109 · urban 5,983 · commissioning_fdd 819.

**By license:** open 640,231 · public-domain 199,222 · cc-by-sa 1,723 · cc-by 18,293.
