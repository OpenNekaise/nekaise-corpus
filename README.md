...
| **Extracted text** | **~80G** (~78.400B chars, **≈19.600B tokens**) |
| **Cleaned corpus** | **~76G** (~74.526B chars, **≈18.631B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 523,567 · construction 421,285 · building_energy 207,988 · structures_civil 168,533 · materials 109,029 · infrastructure 73,634 · architecture 43,970 · standards_protocols 11,561 · controls_bas 11,055 · urban 6,014 · commissioning_fdd 836.

**By license:** open 1,296,224 · public-domain 260,500 · cc-by-sa 1,736 · cc-by 19,012.
<!-- STATS:END -->
