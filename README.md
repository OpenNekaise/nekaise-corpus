...
| **Extracted text** | **~55G** (~54.171B chars, **≈13.543B tokens**) |
| **Cleaned corpus** | **~53G** (~51.871B chars, **≈12.968B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 301,671 · construction 204,315 · building_energy 146,293 · structures_civil 88,633 · materials 59,983 · infrastructure 38,660 · architecture 27,849 · standards_protocols 11,519 · controls_bas 7,030 · urban 5,984 · commissioning_fdd 819.

**By license:** open 670,560 · public-domain 202,162 · cc-by-sa 1,723 · cc-by 18,311.
