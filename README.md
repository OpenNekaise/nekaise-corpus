...
| **Extracted text** | **~51G** (~50.067B chars, **≈12.517B tokens**) |
| **Cleaned corpus** | **~49G** (~48.009B chars, **≈12.002B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 269,555 · construction 172,096 · building_energy 137,786 · structures_civil 76,235 · materials 51,229 · infrastructure 33,492 · architecture 25,065 · standards_protocols 11,505 · urban 5,983 · controls_bas 4,657 · commissioning_fdd 811.

**By license:** open 575,588 · public-domain 192,863 · cc-by-sa 1,723 · cc-by 18,240.
