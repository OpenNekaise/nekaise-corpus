...
| **Extracted text** | **~72G** (~70.230B chars, **≈17.558B tokens**) |
| **Cleaned corpus** | **~68G** (~66.887B chars, **≈16.722B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 446,914 · construction 348,065 · building_energy 186,725 · structures_civil 141,013 · materials 93,518 · infrastructure 62,165 · architecture 38,736 · standards_protocols 11,546 · controls_bas 11,006 · urban 6,007 · commissioning_fdd 830.

**By license:** open 1,084,646 · public-domain 241,380 · cc-by-sa 1,732 · cc-by 18,767.
<!-- STATS:END -->
