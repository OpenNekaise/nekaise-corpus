...
| **Extracted text** | **~66G** (~65.067B chars, **≈16.267B tokens**) |
| **Cleaned corpus** | **~63G** (~62.062B chars, **≈15.516B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 400,236 · construction 301,328 · building_energy 173,365 · structures_civil 123,958 · materials 82,579 · infrastructure 54,648 · architecture 35,433 · standards_protocols 11,531 · controls_bas 10,471 · urban 6,003 · commissioning_fdd 826.

**By license:** open 951,698 · public-domain 228,310 · cc-by-sa 1,732 · cc-by 18,638.
