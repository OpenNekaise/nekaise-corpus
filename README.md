...
| **Extracted text** | **~33G** (~32.516B chars, **≈8.129B tokens**) |
| **Cleaned corpus** | **~32G** (~31.208B chars, **≈7.802B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 172,155 · building_energy 104,622 · construction 88,794 · structures_civil 43,962 · materials 31,103 · infrastructure 18,985 · architecture 15,993 · standards_protocols 9,847 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 340,241 · public-domain 121,958 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
