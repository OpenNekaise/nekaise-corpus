...
| **Extracted text** | **~66G** (~64.780B chars, **≈16.195B tokens**) |
| **Cleaned corpus** | **~63G** (~61.794B chars, **≈15.449B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 397,678 · construction 298,752 · building_energy 172,672 · structures_civil 123,049 · materials 81,937 · infrastructure 54,232 · architecture 35,263 · standards_protocols 11,531 · controls_bas 10,424 · urban 6,002 · commissioning_fdd 826.

**By license:** open 944,404 · public-domain 227,597 · cc-by-sa 1,732 · cc-by 18,633.
