...
| **Raw originals** | **~635G** (PDF / HTML / source code) |
| **Extracted text** | **~55G** (~54.307B chars, **≈13.577B tokens**) |
| **Cleaned corpus** | **~53G** (~51.999B chars, **≈13.000B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 302,827 · construction 205,525 · building_energy 146,594 · structures_civil 89,021 · materials 60,236 · infrastructure 38,847 · architecture 27,938 · standards_protocols 11,519 · controls_bas 7,058 · urban 5,984 · commissioning_fdd 819.

**By license:** open 673,842 · public-domain 202,492 · cc-by-sa 1,723 · cc-by 18,311.
