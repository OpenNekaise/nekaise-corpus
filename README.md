...
| **Extracted text** | **~73G** (~71.193B chars, **≈17.798B tokens**) |
| **Cleaned corpus** | **~69G** (~67.787B chars, **≈16.947B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 455,892 · construction 356,865 · building_energy 189,427 · structures_civil 144,077 · materials 95,328 · infrastructure 63,710 · architecture 39,343 · standards_protocols 11,548 · controls_bas 11,018 · urban 6,007 · commissioning_fdd 831.

**By license:** open 1,109,226 · public-domain 244,292 · cc-by-sa 1,732 · cc-by 18,796.
<!-- STATS:END -->
