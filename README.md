...
| **Extracted text** | **~66G** (~64.971B chars, **≈16.243B tokens**) |
| **Cleaned corpus** | **~63G** (~61.973B chars, **≈15.493B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 399,322 · construction 300,440 · building_energy 173,128 · structures_civil 123,636 · materials 82,371 · infrastructure 54,511 · architecture 35,370 · standards_protocols 11,531 · controls_bas 10,470 · urban 6,003 · commissioning_fdd 826.

**By license:** open 949,228 · public-domain 228,010 · cc-by-sa 1,732 · cc-by 18,638.
