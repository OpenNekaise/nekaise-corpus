...
| **Extracted text** | **~67G** (~65.494B chars, **≈16.374B tokens**) |
| **Cleaned corpus** | **~64G** (~62.463B chars, **≈15.616B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 404,109 · construction 304,992 · building_energy 174,510 · structures_civil 125,380 · materials 83,412 · infrastructure 55,236 · architecture 35,715 · standards_protocols 11,533 · controls_bas 10,700 · urban 6,003 · commissioning_fdd 826.

**By license:** open 962,695 · public-domain 229,349 · cc-by-sa 1,732 · cc-by 18,640.
