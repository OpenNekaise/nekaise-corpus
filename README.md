...
|---|---|
| **Documents** | **502,893** |
| **Raw originals** | **~479G** (PDF / HTML / source code) |
| **Extracted text** | **~33G** (~33.033B chars, **≈8.258B tokens**) |
| **Cleaned corpus** | **~32G** (~31.693B chars, **≈7.923B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 177,071 · building_energy 106,359 · construction 90,421 · structures_civil 44,651 · materials 31,578 · infrastructure 19,386 · architecture 16,562 · standards_protocols 10,063 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 348,116 · public-domain 124,713 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
