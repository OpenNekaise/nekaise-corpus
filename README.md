...
| **Extracted text** | **~31G** (~30.199B chars, **≈7.550B tokens**) |
| **Cleaned corpus** | **~29G** (~29.047B chars, **≈7.262B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 145,619 · building_energy 96,160 · construction 80,518 · structures_civil 39,954 · materials 28,222 · infrastructure 16,923 · architecture 14,054 · standards_protocols 9,077 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 296,515 · public-domain 110,750 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
