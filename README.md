...
| **Extracted text** | **~82G** (~79.989B chars, **≈19.997B tokens**) |
| **Cleaned corpus** | **~78G** (~76.035B chars, **≈19.009B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,885 · construction 431,403 · building_energy 217,248 · structures_civil 172,585 · materials 111,771 · infrastructure 75,654 · architecture 45,314 · standards_protocols 12,082 · controls_bas 11,270 · urban 6,114 · commissioning_fdd 841.

**By license:** open 1,334,205 · public-domain 263,808 · cc-by-sa 1,739 · cc-by 20,415.
<!-- STATS:END -->
