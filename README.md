...
| **Raw originals** | **~661G** (PDF / HTML / source code) |
| **Extracted text** | **~61G** (~59.866B chars, **≈14.967B tokens**) |
| **Cleaned corpus** | **~58G** (~57.206B chars, **≈14.301B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 351,185 · construction 253,026 · building_energy 159,718 · structures_civil 106,538 · materials 71,394 · infrastructure 46,261 · architecture 31,440 · standards_protocols 11,525 · controls_bas 9,246 · urban 5,999 · commissioning_fdd 823.

**By license:** open 810,873 · public-domain 216,060 · cc-by-sa 1,732 · cc-by 18,490.

_Snapshot of the eligible live registry (2026-09-05) — auto-generated from the manifest. Local raw/text
