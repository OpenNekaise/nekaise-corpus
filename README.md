...
| **Extracted text** | **~32G** (~31.504B chars, **≈7.876B tokens**) |
| **Cleaned corpus** | **~31G** (~30.263B chars, **≈7.566B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 161,132 · building_energy 100,857 · construction 85,334 · structures_civil 42,307 · materials 29,951 · infrastructure 18,118 · architecture 15,038 · standards_protocols 9,554 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 322,415 · public-domain 116,614 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
