...
| **Extracted text** | **~45G** (~44.841B chars, **≈11.210B tokens**) |
| **Cleaned corpus** | **~44G** (~43.061B chars, **≈10.765B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 233,839 · construction 140,242 · building_energy 128,476 · structures_civil 64,910 · materials 41,715 · infrastructure 27,877 · architecture 24,102 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,455 · public-domain 172,247 · cc-by-sa 1,723 · cc-by 18,183.
