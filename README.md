...
| **Extracted text** | **~62G** (~60.442B chars, **≈15.111B tokens**) |
| **Cleaned corpus** | **~59G** (~57.744B chars, **≈14.436B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 356,712 · construction 258,385 · building_energy 161,160 · structures_civil 108,335 · materials 72,654 · infrastructure 47,146 · architecture 31,961 · standards_protocols 11,525 · controls_bas 9,455 · urban 5,999 · commissioning_fdd 824.

**By license:** open 826,403 · public-domain 217,506 · cc-by-sa 1,732 · cc-by 18,515.
