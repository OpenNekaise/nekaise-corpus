...
| **Extracted text** | **~33G** (~32.616B chars, **≈8.154B tokens**) |
| **Cleaned corpus** | **~32G** (~31.301B chars, **≈7.825B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 173,120 · building_energy 104,930 · construction 89,142 · structures_civil 44,091 · materials 31,202 · infrastructure 19,077 · architecture 16,115 · standards_protocols 9,936 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 342,005 · public-domain 122,346 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
