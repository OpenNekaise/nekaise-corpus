...
| **Extracted text** | **~45G** (~44.520B chars, **≈11.130B tokens**) |
| **Cleaned corpus** | **~43G** (~42.748B chars, **≈10.687B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 232,804 · construction 139,556 · building_energy 128,093 · structures_civil 64,657 · materials 41,618 · infrastructure 27,782 · architecture 24,013 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,570 · public-domain 169,494 · cc-by-sa 1,723 · cc-by 18,183.
