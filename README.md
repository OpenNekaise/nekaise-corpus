...
| **Extracted text** | **~48G** (~46.784B chars, **≈11.696B tokens**) |
| **Cleaned corpus** | **~45G** (~44.918B chars, **≈11.229B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 245,076 · construction 145,906 · building_energy 130,820 · structures_civil 66,453 · materials 43,850 · infrastructure 29,234 · architecture 22,670 · standards_protocols 11,501 · urban 5,983 · controls_bas 4,271 · commissioning_fdd 804.

**By license:** open 500,776 · public-domain 185,876 · cc-by-sa 1,723 · cc-by 18,193.
