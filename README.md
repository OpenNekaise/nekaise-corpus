...
| **Extracted text** | **~28G** (~27.837B chars, **≈6.959B tokens**) |
| **Cleaned corpus** | **~27G** (~26.839B chars, **≈6.710B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 119,580 · building_energy 87,683 · construction 70,180 · structures_civil 35,255 · materials 25,044 · infrastructure 14,856 · architecture 12,208 · standards_protocols 8,419 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 248,375 · public-domain 101,588 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
