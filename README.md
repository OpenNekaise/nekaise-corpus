...
| **Raw originals** | **~678G** (PDF / HTML / source code) |
| **Extracted text** | **~65G** (~63.492B chars, **≈15.873B tokens**) |
| **Cleaned corpus** | **~62G** (~60.591B chars, **≈15.148B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 385,761 · construction 286,750 · building_energy 169,313 · structures_civil 118,577 · materials 79,252 · infrastructure 52,396 · architecture 34,370 · standards_protocols 11,529 · controls_bas 10,041 · urban 6,002 · commissioning_fdd 826.

**By license:** open 909,433 · public-domain 225,044 · cc-by-sa 1,732 · cc-by 18,608.

_Snapshot of the eligible live registry (2026-09-07) — auto-generated from the manifest. Local raw/text
