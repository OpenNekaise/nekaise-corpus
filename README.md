...
| **Extracted text** | **~46G** (~45.520B chars, **≈11.380B tokens**) |
| **Cleaned corpus** | **~44G** (~43.719B chars, **≈10.930B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 236,400 · construction 141,531 · building_energy 129,176 · structures_civil 65,478 · materials 41,973 · infrastructure 28,082 · architecture 24,304 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 178,030 · cc-by-sa 1,723 · cc-by 18,183.
