...
| **Extracted text** | **~33G** (~33.050B chars, **≈8.263B tokens**) |
| **Cleaned corpus** | **~32G** (~31.709B chars, **≈7.927B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 177,282 · building_energy 106,422 · construction 90,477 · structures_civil 44,678 · materials 31,597 · infrastructure 19,401 · architecture 16,573 · standards_protocols 10,092 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 348,476 · public-domain 124,784 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
