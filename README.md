...
| **Extracted text** | **~36G** (~35.355B chars, **≈8.839B tokens**) |
| **Cleaned corpus** | **~34G** (~33.927B chars, **≈8.482B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 189,109 · building_energy 110,434 · construction 97,851 · structures_civil 48,207 · materials 33,398 · infrastructure 20,812 · architecture 17,731 · standards_protocols 10,692 · controls_bas 3,397 · urban 3,062 · commissioning_fdd 375.

**By license:** open 369,149 · public-domain 135,426 · cc-by-sa 1,720 · cc-by 28,768 · proprietary-internal 5.
