...
| **Extracted text** | **~63G** (~61.472B chars, **≈15.368B tokens**) |
| **Cleaned corpus** | **~60G** (~58.706B chars, **≈14.676B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 366,686 · construction 267,603 · building_energy 163,860 · structures_civil 111,498 · materials 74,887 · infrastructure 48,748 · architecture 32,789 · standards_protocols 11,527 · controls_bas 9,664 · urban 5,999 · commissioning_fdd 824.

**By license:** open 853,711 · public-domain 220,102 · cc-by-sa 1,732 · cc-by 18,540.
