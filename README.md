...
| **Extracted text** | **~63G** (~61.858B chars, **≈15.464B tokens**) |
| **Cleaned corpus** | **~60G** (~59.066B chars, **≈14.767B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 370,473 · construction 271,270 · building_energy 164,962 · structures_civil 112,826 · materials 75,657 · infrastructure 49,506 · architecture 33,108 · standards_protocols 11,527 · controls_bas 9,716 · urban 6,001 · commissioning_fdd 824.

**By license:** open 864,674 · public-domain 220,903 · cc-by-sa 1,732 · cc-by 18,561.
