...
| **Extracted text** | **~46G** (~45.299B chars, **≈11.325B tokens**) |
| **Cleaned corpus** | **~44G** (~43.505B chars, **≈10.876B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,514 · construction 141,080 · building_energy 128,917 · structures_civil 65,285 · materials 41,879 · infrastructure 28,007 · architecture 24,234 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 176,002 · cc-by-sa 1,723 · cc-by 18,183.
