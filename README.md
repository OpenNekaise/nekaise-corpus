...
| **Extracted text** | **~31G** (~31.061B chars, **≈7.765B tokens**) |
| **Cleaned corpus** | **~30G** (~29.850B chars, **≈7.463B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 155,786 · building_energy 99,224 · construction 83,761 · structures_civil 41,557 · materials 29,409 · infrastructure 17,727 · architecture 14,670 · standards_protocols 9,422 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 313,689 · public-domain 114,605 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
