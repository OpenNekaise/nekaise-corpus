...
| **Extracted text** | **~67G** (~65.692B chars, **≈16.423B tokens**) |
| **Cleaned corpus** | **~64G** (~62.647B chars, **≈15.662B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 405,903 · construction 306,796 · building_energy 175,032 · structures_civil 126,058 · materials 83,825 · infrastructure 55,515 · architecture 35,838 · standards_protocols 11,533 · controls_bas 10,702 · urban 6,003 · commissioning_fdd 827.

**By license:** open 967,895 · public-domain 229,763 · cc-by-sa 1,732 · cc-by 18,642.
