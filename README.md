...
| **Extracted text** | **~32G** (~32.053B chars, **≈8.013B tokens**) |
| **Cleaned corpus** | **~31G** (~30.776B chars, **≈7.694B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 167,052 · building_energy 102,870 · construction 87,106 · structures_civil 43,188 · materials 30,572 · infrastructure 18,572 · architecture 15,544 · standards_protocols 9,697 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 331,885 · public-domain 119,454 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
