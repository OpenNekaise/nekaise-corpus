...
| **Extracted text** | **~81G** (~78.709B chars, **≈19.677B tokens**) |
| **Cleaned corpus** | **~76G** (~74.815B chars, **≈18.704B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 526,527 · construction 423,886 · building_energy 208,795 · structures_civil 169,567 · materials 109,635 · infrastructure 74,097 · architecture 44,203 · standards_protocols 11,561 · controls_bas 11,057 · urban 6,014 · commissioning_fdd 836.

**By license:** open 1,304,427 · public-domain 260,999 · cc-by-sa 1,736 · cc-by 19,016.
<!-- STATS:END -->
