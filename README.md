...
| **Extracted text** | **~28G** (~27.711B chars, **≈6.928B tokens**) |
| **Cleaned corpus** | **~27G** (~26.720B chars, **≈6.680B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 118,174 · building_energy 87,159 · construction 69,501 · structures_civil 34,989 · materials 24,876 · infrastructure 14,737 · architecture 12,080 · standards_protocols 8,410 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 245,503 · public-domain 101,161 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
