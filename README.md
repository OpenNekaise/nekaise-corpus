...
| **Extracted text** | **~25G** (~25.263B chars, **≈6.316B tokens**) |
| **Cleaned corpus** | **~25G** (~24.433B chars, **≈6.108B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 92,523 · building_energy 78,010 · construction 58,467 · structures_civil 29,597 · materials 21,601 · infrastructure 12,368 · architecture 9,854 · standards_protocols 8,057 · urban 3,032 · controls_bas 3,013 · commissioning_fdd 374.

**By license:** open 194,937 · public-domain 91,895 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
