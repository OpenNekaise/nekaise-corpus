...
| **Extracted text** | **~46G** (~32.857B chars, **≈8.214B tokens**) |
| **Cleaned corpus** | **~31G** (~31.985B chars, **≈7.996B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 85,968 · equipment_systems 71,556 · construction 50,079 · structures_civil 20,769 · materials 17,129 · architecture 12,341 · standards_protocols 11,495 · infrastructure 10,016 · urban 5,982 · controls_bas 4,124 · commissioning_fdd 802.

**By license:** open 88,613 · public-domain 181,754 · cc-by-sa 1,723 · cc-by 18,171.
