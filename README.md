...
|---|---|
| **Documents** | **130,818** |
| **Raw originals** | **~331G** (PDF / HTML / source code) |
| **Extracted text** | **~16G** (~15.560B chars, **≈3.890B tokens**) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 45,767 · equipment_systems 27,099 · construction 20,348 · structures_civil 13,281 · materials 6,742 · infrastructure 5,528 · architecture 3,877 · standards_protocols 3,404 · urban 2,856 · controls_bas 1,543 · commissioning_fdd 373.

**By license:** open 51,889 · public-domain 56,016 · cc-by-sa 1,648 · cc-by 21,260 · proprietary-internal 5.
