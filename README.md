...
| **Extracted text** | **~55G** (~53.889B chars, **≈13.472B tokens**) |
| **Cleaned corpus** | **~52G** (~51.606B chars, **≈12.901B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 299,552 · construction 202,091 · building_energy 145,692 · structures_civil 87,796 · materials 59,270 · infrastructure 38,420 · architecture 27,708 · standards_protocols 11,518 · controls_bas 6,772 · urban 5,984 · commissioning_fdd 819.

**By license:** open 664,032 · public-domain 201,557 · cc-by-sa 1,723 · cc-by 18,310.
