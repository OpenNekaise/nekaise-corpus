...
| **Extracted text** | **~58G** (~56.985B chars, **≈14.246B tokens**) |
| **Cleaned corpus** | **~55G** (~54.511B chars, **≈13.628B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 325,269 · construction 228,171 · building_energy 152,526 · structures_civil 97,176 · materials 65,964 · infrastructure 42,281 · architecture 29,562 · standards_protocols 11,521 · controls_bas 8,324 · urban 5,997 · commissioning_fdd 819.

**By license:** open 738,512 · public-domain 208,947 · cc-by-sa 1,732 · cc-by 18,419.
