...
| **Extracted text** | **~46G** (~45.107B chars, **≈11.277B tokens**) |
| **Cleaned corpus** | **~44G** (~43.319B chars, **≈10.830B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 234,792 · construction 140,721 · building_energy 128,738 · structures_civil 65,119 · materials 41,804 · infrastructure 27,957 · architecture 24,183 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,455 · public-domain 174,400 · cc-by-sa 1,723 · cc-by 18,183.
