...
|---|---|
| **Documents** | **97,303** |
| **Raw originals** | **~273G** (PDF / HTML / source code) |
| **Extracted text** | **~13G** (~12.553B chars, **≈3.138B tokens**) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 37,131 · equipment_systems 20,852 · construction 14,273 · structures_civil 8,231 · materials 4,631 · infrastructure 3,580 · architecture 3,086 · standards_protocols 2,449 · controls_bas 1,385 · urban 1,312 · commissioning_fdd 373.

**By license:** open 34,568 · public-domain 48,647 · cc-by-sa 1,609 · cc-by 12,474 · proprietary-internal 5.
