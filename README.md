...
| **Extracted text** | **~46G** (~32.744B chars, **≈8.186B tokens**) |
| **Cleaned corpus** | **~31G** (~31.876B chars, **≈7.969B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 85,825 · equipment_systems 71,084 · construction 49,794 · structures_civil 20,675 · materials 17,085 · architecture 12,311 · standards_protocols 11,509 · infrastructure 9,980 · urban 5,982 · controls_bas 4,149 · commissioning_fdd 832.

**By license:** open 88,716 · public-domain 180,597 · cc-by-sa 1,723 · cc-by 18,190.
