...
| **Extracted text** | **~72G** (~70.614B chars, **≈17.654B tokens**) |
| **Cleaned corpus** | **~68G** (~67.246B chars, **≈16.812B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 450,501 · construction 351,456 · building_energy 187,797 · structures_civil 142,237 · materials 94,260 · infrastructure 62,809 · architecture 38,965 · standards_protocols 11,547 · controls_bas 11,008 · urban 6,007 · commissioning_fdd 831.

**By license:** open 1,094,340 · public-domain 242,569 · cc-by-sa 1,732 · cc-by 18,777.
<!-- STATS:END -->
