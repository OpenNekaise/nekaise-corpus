...
| **Raw originals** | **~632G** (PDF / HTML / source code) |
| **Extracted text** | **~55G** (~54.019B chars, **≈13.505B tokens**) |
| **Cleaned corpus** | **~53G** (~51.728B chars, **≈12.932B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 300,473 · construction 203,011 · building_energy 145,936 · structures_civil 88,130 · materials 59,457 · infrastructure 38,530 · architecture 27,780 · standards_protocols 11,518 · controls_bas 6,948 · urban 5,984 · commissioning_fdd 819.

**By license:** open 666,728 · public-domain 201,825 · cc-by-sa 1,723 · cc-by 18,310.
