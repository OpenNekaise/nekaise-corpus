...
| **Extracted text** | **~66G** (~64.584B chars, **≈16.146B tokens**) |
| **Cleaned corpus** | **~63G** (~61.611B chars, **≈15.403B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 395,940 · construction 296,933 · building_energy 172,164 · structures_civil 122,345 · materials 81,553 · infrastructure 53,938 · architecture 35,121 · standards_protocols 11,531 · controls_bas 10,348 · urban 6,002 · commissioning_fdd 826.

**By license:** open 939,140 · public-domain 227,204 · cc-by-sa 1,732 · cc-by 18,625.
