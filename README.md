...
| **Extracted text** | **~46G** (~45.510B chars, **≈11.377B tokens**) |
| **Cleaned corpus** | **~44G** (~43.710B chars, **≈10.927B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 236,353 · construction 141,509 · building_energy 129,164 · structures_civil 65,468 · materials 41,968 · infrastructure 28,080 · architecture 24,304 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 177,932 · cc-by-sa 1,723 · cc-by 18,183.
