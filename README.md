...
| **Extracted text** | **~47G** (~32.994B chars, **≈8.248B tokens**) |
| **Cleaned corpus** | **~31G** (~32.117B chars, **≈8.029B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 86,156 · equipment_systems 72,086 · construction 50,377 · structures_civil 20,874 · materials 17,175 · architecture 12,377 · standards_protocols 11,501 · infrastructure 10,057 · urban 5,982 · controls_bas 4,125 · commissioning_fdd 804.

**By license:** open 88,620 · public-domain 182,992 · cc-by-sa 1,723 · cc-by 18,179.
