...
| **Extracted text** | **~63G** (~61.503B chars, **≈15.376B tokens**) |
| **Cleaned corpus** | **~60G** (~58.735B chars, **≈14.684B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 366,960 · construction 267,888 · building_energy 163,962 · structures_civil 111,599 · materials 74,947 · infrastructure 48,809 · architecture 32,823 · standards_protocols 11,527 · controls_bas 9,664 · urban 5,999 · commissioning_fdd 824.

**By license:** open 854,570 · public-domain 220,156 · cc-by-sa 1,732 · cc-by 18,544.
