...
| **Extracted text** | **~75G** (~73.613B chars, **≈18.403B tokens**) |
| **Cleaned corpus** | **~71G** (~70.047B chars, **≈17.512B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 479,335 · construction 379,064 · building_energy 195,725 · structures_civil 152,356 · materials 99,982 · infrastructure 67,093 · architecture 40,899 · standards_protocols 11,552 · controls_bas 11,027 · urban 6,010 · commissioning_fdd 832.

**By license:** open 1,172,876 · public-domain 250,390 · cc-by-sa 1,734 · cc-by 18,875.
<!-- STATS:END -->
