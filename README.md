...
| **Extracted text** | **~51G** (~49.837B chars, **≈12.459B tokens**) |
| **Cleaned corpus** | **~48G** (~47.794B chars, **≈11.949B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 267,761 · construction 170,088 · building_energy 137,238 · structures_civil 75,564 · materials 50,620 · infrastructure 33,182 · architecture 24,918 · standards_protocols 11,503 · urban 5,983 · controls_bas 4,619 · commissioning_fdd 811.

**By license:** open 570,070 · public-domain 192,258 · cc-by-sa 1,723 · cc-by 18,236.
