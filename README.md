...
| **Extracted text** | **~46G** (~45.247B chars, **≈11.312B tokens**) |
| **Cleaned corpus** | **~44G** (~43.455B chars, **≈10.864B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,316 · construction 140,973 · building_energy 128,873 · structures_civil 65,248 · materials 41,857 · infrastructure 28,000 · architecture 24,220 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 175,573 · cc-by-sa 1,723 · cc-by 18,183.
