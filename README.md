...
| **Extracted text** | **~45G** (~44.692B chars, **≈11.173B tokens**) |
| **Cleaned corpus** | **~44G** (~42.916B chars, **≈10.729B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 233,399 · construction 139,921 · building_energy 128,276 · structures_civil 64,803 · materials 41,663 · infrastructure 27,831 · architecture 24,055 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,570 · public-domain 170,919 · cc-by-sa 1,723 · cc-by 18,183.
