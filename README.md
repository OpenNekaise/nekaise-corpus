...
| **Extracted text** | **~61G** (~59.318B chars, **≈14.830B tokens**) |
| **Cleaned corpus** | **~58G** (~56.694B chars, **≈14.173B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 345,778 · construction 248,080 · building_energy 158,237 · structures_civil 104,669 · materials 70,178 · infrastructure 45,413 · architecture 31,000 · standards_protocols 11,525 · controls_bas 9,104 · urban 5,999 · commissioning_fdd 823.

**By license:** open 795,955 · public-domain 214,646 · cc-by-sa 1,732 · cc-by 18,473.
