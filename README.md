...
| **Extracted text** | **~55G** (~54.290B chars, **≈13.572B tokens**) |
| **Cleaned corpus** | **~53G** (~51.983B chars, **≈12.996B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 302,645 · construction 205,369 · building_energy 146,549 · structures_civil 88,976 · materials 60,199 · infrastructure 38,831 · architecture 27,922 · standards_protocols 11,519 · controls_bas 7,058 · urban 5,984 · commissioning_fdd 819.

**By license:** open 673,385 · public-domain 202,452 · cc-by-sa 1,723 · cc-by 18,311.
