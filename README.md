...
| **Extracted text** | **~60G** (~58.708B chars, **≈14.677B tokens**) |
| **Cleaned corpus** | **~57G** (~56.124B chars, **≈14.031B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 340,186 · construction 242,816 · building_energy 156,702 · structures_civil 102,612 · materials 68,985 · infrastructure 44,517 · architecture 30,585 · standards_protocols 11,523 · controls_bas 8,848 · urban 5,999 · commissioning_fdd 821.

**By license:** open 780,207 · public-domain 213,190 · cc-by-sa 1,732 · cc-by 18,465.
