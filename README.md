...
|---|---|
| **Documents** | **82,705** |
| **Raw originals** | **~244G** (PDF / HTML / source code) |
| **Extracted text** | **~11G** (~11.068B chars, **≈2.767B tokens**) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 31,682 · equipment_systems 17,652 · construction 11,688 · structures_civil 7,283 · materials 3,882 · infrastructure 3,028 · architecture 2,781 · standards_protocols 1,903 · controls_bas 1,350 · urban 1,085 · commissioning_fdd 371.

**By license:** open 27,232 · public-domain 43,793 · cc-by-sa 1,607 · cc-by 10,068 · proprietary-internal 5.
