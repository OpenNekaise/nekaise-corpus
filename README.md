...
| **Extracted text** | **~63G** (~62.129B chars, **≈15.532B tokens**) |
| **Cleaned corpus** | **~60G** (~59.319B chars, **≈14.830B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 372,922 · construction 273,825 · building_energy 165,679 · structures_civil 113,811 · materials 76,277 · infrastructure 50,032 · architecture 33,337 · standards_protocols 11,527 · controls_bas 9,766 · urban 6,001 · commissioning_fdd 825.

**By license:** open 872,138 · public-domain 221,570 · cc-by-sa 1,732 · cc-by 18,562.
