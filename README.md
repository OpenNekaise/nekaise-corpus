...
| **Extracted text** | **~33G** (~32.245B chars, **≈8.061B tokens**) |
| **Cleaned corpus** | **~31G** (~30.955B chars, **≈7.739B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 169,092 · building_energy 103,583 · construction 87,850 · structures_civil 43,521 · materials 30,794 · infrastructure 18,739 · architecture 15,764 · standards_protocols 9,762 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 335,243 · public-domain 120,600 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
