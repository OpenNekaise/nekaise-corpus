...
| **Extracted text** | **~67G** (~65.676B chars, **≈16.419B tokens**) |
| **Cleaned corpus** | **~64G** (~62.633B chars, **≈15.658B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 405,759 · construction 306,663 · building_energy 174,992 · structures_civil 126,017 · materials 83,781 · infrastructure 55,495 · architecture 35,829 · standards_protocols 11,533 · controls_bas 10,702 · urban 6,003 · commissioning_fdd 827.

**By license:** open 967,500 · public-domain 229,727 · cc-by-sa 1,732 · cc-by 18,642.
