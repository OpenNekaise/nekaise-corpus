...
| **Extracted text** | **~29G** (~28.416B chars, **≈7.104B tokens**) |
| **Cleaned corpus** | **~28G** (~27.379B chars, **≈6.845B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 126,221 · building_energy 89,934 · construction 72,478 · structures_civil 36,430 · materials 25,864 · infrastructure 15,343 · architecture 12,694 · standards_protocols 8,592 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 260,410 · public-domain 103,884 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
