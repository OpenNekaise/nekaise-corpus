...
| **Extracted text** | **~29G** (~28.356B chars, **≈7.089B tokens**) |
| **Cleaned corpus** | **~28G** (~27.323B chars, **≈6.831B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 125,526 · building_energy 89,738 · construction 72,286 · structures_civil 36,299 · materials 25,793 · infrastructure 15,302 · architecture 12,653 · standards_protocols 8,558 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 259,233 · public-domain 103,660 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
