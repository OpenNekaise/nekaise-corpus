...
| **Extracted text** | **~56G** (~54.515B chars, **≈13.629B tokens**) |
| **Cleaned corpus** | **~53G** (~52.194B chars, **≈13.049B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 304,677 · construction 207,151 · building_energy 147,045 · structures_civil 89,620 · materials 60,541 · infrastructure 39,116 · architecture 28,053 · standards_protocols 11,519 · controls_bas 7,216 · urban 5,984 · commissioning_fdd 819.

**By license:** open 678,657 · public-domain 203,041 · cc-by-sa 1,723 · cc-by 18,320.
