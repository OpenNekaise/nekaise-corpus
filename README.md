...
| **Extracted text** | **~40G** (~39.301B chars, **≈9.825B tokens**) |
| **Cleaned corpus** | **~38G** (~37.733B chars, **≈9.433B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 204,003 · building_energy 119,254 · construction 112,847 · structures_civil 53,700 · materials 35,956 · infrastructure 23,605 · architecture 21,426 · standards_protocols 10,878 · urban 5,886 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 404,857 · public-domain 147,179 · cc-by-sa 1,723 · cc-by 37,570.
