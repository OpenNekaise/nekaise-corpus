...
| **Extracted text** | **~69G** (~67.271B chars, **≈16.818B tokens**) |
| **Cleaned corpus** | **~65G** (~64.122B chars, **≈16.030B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 420,056 · construction 321,152 · building_energy 179,165 · structures_civil 131,410 · materials 87,317 · infrastructure 57,726 · architecture 36,900 · standards_protocols 11,540 · controls_bas 10,989 · urban 6,005 · commissioning_fdd 830.

**By license:** open 1,009,047 · public-domain 233,622 · cc-by-sa 1,732 · cc-by 18,689.
