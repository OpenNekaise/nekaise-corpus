...
| **Extracted text** | **~65G** (~63.590B chars, **≈15.898B tokens**) |
| **Cleaned corpus** | **~62G** (~60.682B chars, **≈15.171B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 386,661 · construction 287,716 · building_energy 169,575 · structures_civil 118,941 · materials 79,465 · infrastructure 52,543 · architecture 34,446 · standards_protocols 11,529 · controls_bas 10,093 · urban 6,002 · commissioning_fdd 826.

**By license:** open 912,225 · public-domain 225,232 · cc-by-sa 1,732 · cc-by 18,608.
