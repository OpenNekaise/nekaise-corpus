...
| **Extracted text** | **~46G** (~45.384B chars, **≈11.346B tokens**) |
| **Cleaned corpus** | **~44G** (~43.588B chars, **≈10.897B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,841 · construction 141,251 · building_energy 129,020 · structures_civil 65,375 · materials 41,908 · infrastructure 28,038 · architecture 24,262 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 176,781 · cc-by-sa 1,723 · cc-by 18,183.
