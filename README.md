...
| **Extracted text** | **~69G** (~67.333B chars, **≈16.833B tokens**) |
| **Cleaned corpus** | **~65G** (~64.180B chars, **≈16.045B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 420,621 · construction 321,726 · building_energy 179,324 · structures_civil 131,600 · materials 87,467 · infrastructure 57,815 · architecture 36,939 · standards_protocols 11,540 · controls_bas 10,989 · urban 6,005 · commissioning_fdd 830.

**By license:** open 1,010,634 · public-domain 233,799 · cc-by-sa 1,732 · cc-by 18,691.
