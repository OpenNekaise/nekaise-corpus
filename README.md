...
| **Extracted text** | **~52G** (~50.790B chars, **≈12.697B tokens**) |
| **Cleaned corpus** | **~49G** (~48.689B chars, **≈12.172B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 274,664 · construction 178,074 · building_energy 139,264 · structures_civil 78,523 · materials 53,035 · infrastructure 34,455 · architecture 25,581 · standards_protocols 11,514 · urban 5,983 · controls_bas 4,844 · commissioning_fdd 816.

**By license:** open 592,307 · public-domain 194,462 · cc-by-sa 1,723 · cc-by 18,261.
