...
| **Extracted text** | **~44G** (~43.825B chars, **≈10.956B tokens**) |
| **Cleaned corpus** | **~43G** (~42.081B chars, **≈10.520B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 229,125 · construction 136,112 · building_energy 127,013 · structures_civil 63,335 · materials 40,882 · infrastructure 27,264 · architecture 23,698 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 483,796 · public-domain 166,174 · cc-by-sa 1,723 · cc-by 18,183.
