...
| **Extracted text** | **~78G** (~76.805B chars, **≈19.201B tokens**) |
| **Cleaned corpus** | **~74G** (~73.033B chars, **≈18.258B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 508,505 · construction 407,335 · building_energy 203,926 · structures_civil 163,231 · materials 105,932 · infrastructure 71,338 · architecture 42,858 · standards_protocols 11,558 · controls_bas 11,035 · urban 6,014 · commissioning_fdd 835.

**By license:** open 1,254,191 · public-domain 257,662 · cc-by-sa 1,734 · cc-by 18,980.
<!-- STATS:END -->
