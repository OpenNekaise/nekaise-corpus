...
| **Extracted text** | **~52G** (~51.043B chars, **≈12.761B tokens**) |
| **Cleaned corpus** | **~50G** (~48.926B chars, **≈12.232B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 276,711 · construction 180,012 · building_energy 139,779 · structures_civil 79,273 · materials 53,421 · infrastructure 34,770 · architecture 25,746 · standards_protocols 11,514 · urban 5,983 · controls_bas 5,005 · commissioning_fdd 819.

**By license:** open 598,001 · public-domain 195,044 · cc-by-sa 1,723 · cc-by 18,265.
