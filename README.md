...
| **Extracted text** | **~46G** (~45.139B chars, **≈11.285B tokens**) |
| **Cleaned corpus** | **~44G** (~43.350B chars, **≈10.837B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 234,919 · construction 140,770 · building_energy 128,772 · structures_civil 65,145 · materials 41,816 · infrastructure 27,967 · architecture 24,192 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,455 · public-domain 174,667 · cc-by-sa 1,723 · cc-by 18,183.
