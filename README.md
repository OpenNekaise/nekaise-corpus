...
| **Extracted text** | **~74G** (~72.518B chars, **≈18.129B tokens**) |
| **Cleaned corpus** | **~70G** (~69.024B chars, **≈17.256B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 468,899 · construction 368,953 · building_energy 192,981 · structures_civil 148,657 · materials 97,943 · infrastructure 65,593 · architecture 40,222 · standards_protocols 11,550 · controls_bas 11,023 · urban 6,009 · commissioning_fdd 831.

**By license:** open 1,144,457 · public-domain 247,623 · cc-by-sa 1,734 · cc-by 18,847.
<!-- STATS:END -->
