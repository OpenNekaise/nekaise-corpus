...
| **Extracted text** | **~46G** (~45.000B chars, **≈11.250B tokens**) |
| **Cleaned corpus** | **~44G** (~43.215B chars, **≈10.804B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 234,412 · construction 140,511 · building_energy 128,621 · structures_civil 65,036 · materials 41,763 · infrastructure 27,916 · architecture 24,147 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,455 · public-domain 173,492 · cc-by-sa 1,723 · cc-by 18,183.
