...
| **Extracted text** | **~41G** (~40.460B chars, **≈10.115B tokens**) |
| **Cleaned corpus** | **~39G** (~38.836B chars, **≈9.709B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 211,059 · building_energy 121,162 · construction 120,905 · structures_civil 56,405 · materials 37,369 · infrastructure 24,715 · architecture 21,967 · standards_protocols 10,878 · urban 5,886 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 423,632 · public-domain 151,195 · cc-by-sa 1,723 · cc-by 37,570.
