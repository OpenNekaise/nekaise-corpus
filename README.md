...
| **Extracted text** | **~33G** (~33.006B chars, **≈8.251B tokens**) |
| **Cleaned corpus** | **~32G** (~31.667B chars, **≈7.917B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 176,733 · building_energy 106,253 · construction 90,339 · structures_civil 44,609 · materials 31,554 · infrastructure 19,354 · architecture 16,530 · standards_protocols 10,050 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 347,614 · public-domain 124,546 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
