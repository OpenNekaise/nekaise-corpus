...
| **Extracted text** | **~65G** (~63.477B chars, **≈15.869B tokens**) |
| **Cleaned corpus** | **~62G** (~60.577B chars, **≈15.144B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 385,616 · construction 286,624 · building_energy 169,272 · structures_civil 118,519 · materials 79,228 · infrastructure 52,375 · architecture 34,355 · standards_protocols 11,529 · controls_bas 10,041 · urban 6,002 · commissioning_fdd 826.

**By license:** open 909,038 · public-domain 225,009 · cc-by-sa 1,732 · cc-by 18,608.
