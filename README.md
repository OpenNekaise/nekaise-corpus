...
| **Extracted text** | **~24G** (~24.161B chars, **≈6.040B tokens**) |
| **Cleaned corpus** | **~24G** (~23.392B chars, **≈5.848B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 83,019 · building_energy 73,689 · construction 54,165 · structures_civil 27,606 · materials 20,241 · infrastructure 11,471 · architecture 9,039 · standards_protocols 7,932 · urban 2,973 · controls_bas 2,949 · commissioning_fdd 374.

**By license:** open 175,995 · public-domain 87,931 · cc-by-sa 1,659 · cc-by 27,868 · proprietary-internal 5.
