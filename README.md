...
|---|---|
| **Documents** | **92,646** |
| **Raw originals** | **~269G** (PDF / HTML / source code) |
| **Extracted text** | **~12G** (~12.188B chars, **≈3.047B tokens**) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 36,167 · equipment_systems 19,592 · construction 13,193 · structures_civil 7,824 · materials 4,354 · infrastructure 3,408 · architecture 2,963 · standards_protocols 2,113 · controls_bas 1,385 · urban 1,274 · commissioning_fdd 373.

**By license:** open 31,450 · public-domain 47,961 · cc-by-sa 1,607 · cc-by 11,623 · proprietary-internal 5.
