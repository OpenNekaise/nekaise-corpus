...
| **Extracted text** | **~49G** (~48.401B chars, **≈12.100B tokens**) |
| **Cleaned corpus** | **~47G** (~46.445B chars, **≈11.611B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 257,065 · construction 158,410 · building_energy 134,042 · structures_civil 71,170 · materials 47,382 · infrastructure 31,299 · architecture 23,939 · standards_protocols 11,502 · urban 5,983 · controls_bas 4,535 · commissioning_fdd 810.

**By license:** open 537,341 · public-domain 188,856 · cc-by-sa 1,723 · cc-by 18,217.
