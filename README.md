...
| **Extracted text** | **~63G** (~61.612B chars, **≈15.403B tokens**) |
| **Cleaned corpus** | **~60G** (~58.837B chars, **≈14.709B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 368,085 · construction 268,971 · building_energy 164,267 · structures_civil 111,978 · materials 75,160 · infrastructure 49,048 · architecture 32,922 · standards_protocols 11,527 · controls_bas 9,666 · urban 5,999 · commissioning_fdd 824.

**By license:** open 857,840 · public-domain 220,326 · cc-by-sa 1,732 · cc-by 18,549.
