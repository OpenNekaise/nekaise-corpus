...
| **Extracted text** | **~55G** (~53.646B chars, **≈13.412B tokens**) |
| **Cleaned corpus** | **~52G** (~51.378B chars, **≈12.844B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 297,748 · construction 200,049 · building_energy 145,125 · structures_civil 87,062 · materials 58,748 · infrastructure 38,086 · architecture 27,514 · standards_protocols 11,518 · controls_bas 6,738 · urban 5,984 · commissioning_fdd 819.

**By license:** open 658,405 · public-domain 200,956 · cc-by-sa 1,723 · cc-by 18,307.
