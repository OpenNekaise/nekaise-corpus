...
| **Extracted text** | **~64G** (~63.210B chars, **≈15.802B tokens**) |
| **Cleaned corpus** | **~61G** (~60.328B chars, **≈15.082B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 383,105 · construction 284,047 · building_energy 168,574 · structures_civil 117,584 · materials 78,675 · infrastructure 51,900 · architecture 34,174 · standards_protocols 11,529 · controls_bas 10,032 · urban 6,001 · commissioning_fdd 826.

**By license:** open 901,765 · public-domain 224,353 · cc-by-sa 1,732 · cc-by 18,597.
