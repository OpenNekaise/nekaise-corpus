...
| **Extracted text** | **~81G** (~78.755B chars, **≈19.689B tokens**) |
| **Cleaned corpus** | **~76G** (~74.858B chars, **≈18.715B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 526,965 · construction 424,285 · building_energy 208,920 · structures_civil 169,706 · materials 109,720 · infrastructure 74,177 · architecture 44,229 · standards_protocols 11,561 · controls_bas 11,057 · urban 6,014 · commissioning_fdd 836.

**By license:** open 1,305,635 · public-domain 261,083 · cc-by-sa 1,736 · cc-by 19,016.
<!-- STATS:END -->
