...
| **Extracted text** | **~32G** (~32.020B chars, **≈8.005B tokens**) |
| **Cleaned corpus** | **~31G** (~30.745B chars, **≈7.686B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 166,635 · building_energy 102,718 · construction 87,008 · structures_civil 43,133 · materials 30,539 · infrastructure 18,535 · architecture 15,505 · standards_protocols 9,688 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 331,211 · public-domain 119,288 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
