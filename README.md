...
| **Extracted text** | **~69G** (~67.929B chars, **≈16.982B tokens**) |
| **Cleaned corpus** | **~66G** (~64.737B chars, **≈16.184B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 425,946 · construction 327,052 · building_energy 180,881 · structures_civil 133,646 · materials 88,786 · infrastructure 58,703 · architecture 37,352 · standards_protocols 11,542 · controls_bas 10,990 · urban 6,005 · commissioning_fdd 830.

**By license:** open 1,026,109 · public-domain 235,189 · cc-by-sa 1,732 · cc-by 18,703.
