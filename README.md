...
|---|---|
| **Documents** | **365,700** |
| **Raw originals** | **~446G** (PDF / HTML / source code) |
| **Extracted text** | **~28G** (~27.263B chars, **≈6.816B tokens**) |
| **Cleaned corpus** | **~27G** (~26.303B chars, **≈6.576B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 113,422 · building_energy 85,513 · construction 67,399 · structures_civil 33,973 · materials 24,273 · infrastructure 14,276 · architecture 11,719 · standards_protocols 8,324 · controls_bas 3,395 · urban 3,032 · commissioning_fdd 374.

**By license:** open 236,204 · public-domain 99,432 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
