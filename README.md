...
| **Extracted text** | **~32G** (~31.309B chars, **≈7.827B tokens**) |
| **Cleaned corpus** | **~30G** (~30.081B chars, **≈7.520B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 158,763 · building_energy 100,161 · construction 84,602 · structures_civil 41,985 · materials 29,711 · infrastructure 17,956 · architecture 14,854 · standards_protocols 9,503 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 318,491 · public-domain 115,782 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
