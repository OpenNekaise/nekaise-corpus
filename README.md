...
| **Extracted text** | **~69G** (~67.192B chars, **≈16.798B tokens**) |
| **Cleaned corpus** | **~65G** (~64.048B chars, **≈16.012B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 419,351 · construction 320,417 · building_energy 178,935 · structures_civil 131,168 · materials 87,138 · infrastructure 57,628 · architecture 36,850 · standards_protocols 11,540 · controls_bas 10,989 · urban 6,005 · commissioning_fdd 830.

**By license:** open 1,006,991 · public-domain 233,439 · cc-by-sa 1,732 · cc-by 18,689.
