...
| **Extracted text** | **~46G** (~45.420B chars, **≈11.355B tokens**) |
| **Cleaned corpus** | **~44G** (~43.623B chars, **≈10.906B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,976 · construction 141,319 · building_energy 129,067 · structures_civil 65,407 · materials 41,922 · infrastructure 28,046 · architecture 24,279 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 177,102 · cc-by-sa 1,723 · cc-by 18,183.
