...
| **Extracted text** | **~30G** (~29.695B chars, **≈7.424B tokens**) |
| **Cleaned corpus** | **~29G** (~28.576B chars, **≈7.144B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 140,098 · building_energy 94,369 · construction 78,405 · structures_civil 38,938 · materials 27,584 · infrastructure 16,448 · architecture 13,641 · standards_protocols 8,978 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 286,481 · public-domain 108,718 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
