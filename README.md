...
| **Extracted text** | **~29G** (~28.338B chars, **≈7.085B tokens**) |
| **Cleaned corpus** | **~28G** (~27.307B chars, **≈6.827B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 125,281 · building_energy 89,686 · construction 72,226 · structures_civil 36,266 · materials 25,766 · infrastructure 15,282 · architecture 12,632 · standards_protocols 8,552 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 258,835 · public-domain 103,594 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
