...
| **Extracted text** | **~44G** (~43.787B chars, **≈10.947B tokens**) |
| **Cleaned corpus** | **~43G** (~42.045B chars, **≈10.511B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 228,921 · construction 135,936 · building_energy 126,959 · structures_civil 63,269 · materials 40,852 · infrastructure 27,246 · architecture 23,679 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 483,398 · public-domain 166,005 · cc-by-sa 1,723 · cc-by 18,183.
