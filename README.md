...
| **Extracted text** | **~46G** (~45.325B chars, **≈11.331B tokens**) |
| **Cleaned corpus** | **~44G** (~43.531B chars, **≈10.883B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,618 · construction 141,132 · building_energy 128,946 · structures_civil 65,316 · materials 41,889 · infrastructure 28,019 · architecture 24,238 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 176,244 · cc-by-sa 1,723 · cc-by 18,183.
