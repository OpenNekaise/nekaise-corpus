...
| **Raw originals** | **~602G** (PDF / HTML / source code) |
| **Extracted text** | **~51G** (~49.981B chars, **≈12.495B tokens**) |
| **Cleaned corpus** | **~49G** (~47.929B chars, **≈11.982B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 268,830 · construction 171,335 · building_energy 137,586 · structures_civil 75,983 · materials 51,039 · infrastructure 33,374 · architecture 25,009 · standards_protocols 11,505 · urban 5,983 · controls_bas 4,657 · commissioning_fdd 811.

**By license:** open 573,510 · public-domain 192,639 · cc-by-sa 1,723 · cc-by 18,240.
