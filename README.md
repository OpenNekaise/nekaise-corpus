...
| **Extracted text** | **~82G** (~79.871B chars, **≈19.968B tokens**) |
| **Cleaned corpus** | **~78G** (~75.917B chars, **≈18.979B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,867 · construction 431,359 · building_energy 215,519 · structures_civil 172,585 · materials 111,431 · infrastructure 75,654 · architecture 45,279 · standards_protocols 11,891 · controls_bas 11,216 · urban 6,108 · commissioning_fdd 841.

**By license:** open 1,332,244 · public-domain 263,553 · cc-by-sa 1,737 · cc-by 20,216.
<!-- STATS:END -->
