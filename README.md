...
| **Extracted text** | **~52G** (~51.132B chars, **≈12.783B tokens**) |
| **Cleaned corpus** | **~50G** (~49.011B chars, **≈12.253B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 277,408 · construction 180,629 · building_energy 139,921 · structures_civil 79,502 · materials 53,605 · infrastructure 34,867 · architecture 25,801 · standards_protocols 11,514 · urban 5,983 · controls_bas 5,079 · commissioning_fdd 819.

**By license:** open 599,914 · public-domain 195,225 · cc-by-sa 1,723 · cc-by 18,266.
