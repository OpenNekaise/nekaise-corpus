...
| **Extracted text** | **~41G** (~40.436B chars, **≈10.109B tokens**) |
| **Cleaned corpus** | **~39G** (~38.813B chars, **≈9.703B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 210,897 · building_energy 121,108 · construction 120,741 · structures_civil 56,355 · materials 37,338 · infrastructure 24,698 · architecture 21,955 · standards_protocols 10,878 · urban 5,886 · controls_bas 3,398 · commissioning_fdd 376.

**By license:** open 423,232 · public-domain 151,105 · cc-by-sa 1,723 · cc-by 37,570.
