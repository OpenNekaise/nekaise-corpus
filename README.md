...
| **Extracted text** | **~49G** (~47.917B chars, **≈11.979B tokens**) |
| **Cleaned corpus** | **~46G** (~45.989B chars, **≈11.497B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 253,397 · construction 154,572 · building_energy 133,079 · structures_civil 69,581 · materials 46,265 · infrastructure 30,644 · architecture 23,599 · standards_protocols 11,502 · urban 5,983 · controls_bas 4,460 · commissioning_fdd 810.

**By license:** open 525,694 · public-domain 188,271 · cc-by-sa 1,723 · cc-by 18,204.
