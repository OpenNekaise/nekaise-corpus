...
| **Extracted text** | **~46G** (~45.414B chars, **≈11.353B tokens**) |
| **Cleaned corpus** | **~44G** (~43.617B chars, **≈10.904B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 235,951 · construction 141,305 · building_energy 129,058 · structures_civil 65,403 · materials 41,921 · infrastructure 28,044 · architecture 24,275 · standards_protocols 11,509 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,456 · public-domain 177,043 · cc-by-sa 1,723 · cc-by 18,183.
