...
|---|---|
| **Documents** | **215,470** |
| **Raw originals** | **~385G** (PDF / HTML / source code) |
| **Extracted text** | **~20G** (~20.375B chars, **≈5.094B tokens**) |
| **Cleaned corpus** | **~20G** (~19.799B chars, **≈4.950B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): building_energy 58,063 · equipment_systems 54,438 · construction 39,345 · structures_civil 21,363 · materials 14,354 · infrastructure 8,850 · standards_protocols 6,959 · architecture 6,435 · urban 2,973 · controls_bas 2,316 · commissioning_fdd 374.

**By license:** open 111,970 · public-domain 74,810 · cc-by-sa 1,648 · cc-by 27,037 · proprietary-internal 5.

_Snapshot of the live registry (2026-08-03) — auto-generated from the manifest. The bytes are not
