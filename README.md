...
| **Extracted text** | **~66G** (~64.220B chars, **≈16.055B tokens**) |
| **Cleaned corpus** | **~62G** (~61.271B chars, **≈15.318B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 392,512 · construction 293,691 · building_energy 171,229 · structures_civil 121,097 · materials 80,843 · infrastructure 53,450 · architecture 34,855 · standards_protocols 11,531 · controls_bas 10,237 · urban 6,002 · commissioning_fdd 826.

**By license:** open 929,353 · public-domain 226,570 · cc-by-sa 1,732 · cc-by 18,618.
