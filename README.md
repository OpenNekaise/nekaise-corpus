...
| **Extracted text** | **~52G** (~51.114B chars, **≈12.778B tokens**) |
| **Cleaned corpus** | **~50G** (~48.994B chars, **≈12.249B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 277,279 · construction 180,469 · building_energy 139,890 · structures_civil 79,427 · materials 53,519 · infrastructure 34,848 · architecture 25,788 · standards_protocols 11,514 · urban 5,983 · controls_bas 5,079 · commissioning_fdd 819.

**By license:** open 599,443 · public-domain 195,183 · cc-by-sa 1,723 · cc-by 18,266.
