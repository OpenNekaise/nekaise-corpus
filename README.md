...
| **Extracted text** | **~82G** (~79.784B chars, **≈19.946B tokens**) |
| **Cleaned corpus** | **~78G** (~75.830B chars, **≈18.958B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,837 · construction 431,344 · building_energy 213,866 · structures_civil 172,585 · materials 111,390 · infrastructure 75,654 · architecture 45,276 · standards_protocols 11,572 · controls_bas 11,188 · urban 6,097 · commissioning_fdd 841.

**By license:** open 1,330,763 · public-domain 263,124 · cc-by-sa 1,736 · cc-by 20,027.
<!-- STATS:END -->
