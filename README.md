...
| **Extracted text** | **~61G** (~59.713B chars, **≈14.928B tokens**) |
| **Cleaned corpus** | **~58G** (~57.063B chars, **≈14.266B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 349,766 · construction 251,633 · building_energy 159,288 · structures_civil 106,001 · materials 71,042 · infrastructure 46,011 · architecture 31,317 · standards_protocols 11,525 · controls_bas 9,238 · urban 5,999 · commissioning_fdd 823.

**By license:** open 806,791 · public-domain 215,635 · cc-by-sa 1,732 · cc-by 18,485.
