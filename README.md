...
| **Extracted text** | **~50G** (~49.007B chars, **≈12.252B tokens**) |
| **Cleaned corpus** | **~48G** (~47.014B chars, **≈11.754B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 261,540 · construction 163,129 · building_energy 135,426 · structures_civil 73,034 · materials 48,692 · infrastructure 32,079 · architecture 24,366 · standards_protocols 11,502 · urban 5,983 · controls_bas 4,570 · commissioning_fdd 811.

**By license:** open 550,858 · public-domain 190,322 · cc-by-sa 1,723 · cc-by 18,229.
