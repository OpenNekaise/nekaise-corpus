...
| **Extracted text** | **~60G** (~59.165B chars, **≈14.791B tokens**) |
| **Cleaned corpus** | **~57G** (~56.550B chars, **≈14.138B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 344,365 · construction 246,711 · building_energy 157,861 · structures_civil 104,132 · materials 69,863 · infrastructure 45,192 · architecture 30,907 · standards_protocols 11,525 · controls_bas 8,992 · urban 5,999 · commissioning_fdd 822.

**By license:** open 791,912 · public-domain 214,255 · cc-by-sa 1,732 · cc-by 18,470.
