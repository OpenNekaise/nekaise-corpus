...
| **Extracted text** | **~65G** (~64.061B chars, **≈16.015B tokens**) |
| **Cleaned corpus** | **~62G** (~61.122B chars, **≈15.281B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 391,089 · construction 292,145 · building_energy 170,799 · structures_civil 120,561 · materials 80,473 · infrastructure 53,211 · architecture 34,757 · standards_protocols 11,531 · controls_bas 10,237 · urban 6,002 · commissioning_fdd 826.

**By license:** open 924,956 · public-domain 226,327 · cc-by-sa 1,732 · cc-by 18,616.
