...
| **Raw originals** | **~627G** (PDF / HTML / source code) |
| **Extracted text** | **~54G** (~53.311B chars, **≈13.328B tokens**) |
| **Cleaned corpus** | **~52G** (~51.062B chars, **≈12.765B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 294,936 · construction 197,437 · building_energy 144,430 · structures_civil 86,050 · materials 58,096 · infrastructure 37,669 · architecture 27,288 · standards_protocols 11,516 · controls_bas 6,462 · urban 5,984 · commissioning_fdd 819.

**By license:** open 650,454 · public-domain 200,208 · cc-by-sa 1,723 · cc-by 18,302.
