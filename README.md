...
| **Extracted text** | **~46G** (~45.147B chars, **≈11.287B tokens**) |
| **Cleaned corpus** | **~44G** (~43.358B chars, **≈10.839B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 234,951 · construction 140,793 · building_energy 128,778 · structures_civil 65,150 · materials 41,820 · infrastructure 27,971 · architecture 24,193 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 491,455 · public-domain 174,742 · cc-by-sa 1,723 · cc-by 18,183.
