...
| **Extracted text** | **~64G** (~62.944B chars, **≈15.736B tokens**) |
| **Cleaned corpus** | **~61G** (~60.080B chars, **≈15.020B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 380,630 · construction 281,561 · building_energy 167,885 · structures_civil 116,659 · materials 78,053 · infrastructure 51,495 · architecture 33,969 · standards_protocols 11,529 · controls_bas 9,934 · urban 6,001 · commissioning_fdd 826.

**By license:** open 894,591 · public-domain 223,640 · cc-by-sa 1,732 · cc-by 18,579.
