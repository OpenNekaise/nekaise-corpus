...
| **Extracted text** | **~34G** (~33.178B chars, **≈8.295B tokens**) |
| **Cleaned corpus** | **~32G** (~31.828B chars, **≈7.957B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 178,717 · building_energy 106,888 · construction 90,949 · structures_civil 44,867 · materials 31,740 · infrastructure 19,485 · architecture 16,695 · standards_protocols 10,149 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 350,757 · public-domain 125,471 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
