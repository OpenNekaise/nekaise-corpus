...
| **Extracted text** | **~63G** (~61.925B chars, **≈15.481B tokens**) |
| **Cleaned corpus** | **~60G** (~59.129B chars, **≈14.782B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 371,119 · construction 271,878 · building_energy 165,150 · structures_civil 113,057 · materials 75,801 · infrastructure 49,625 · architecture 33,176 · standards_protocols 11,527 · controls_bas 9,716 · urban 6,001 · commissioning_fdd 824.

**By license:** open 866,495 · public-domain 221,086 · cc-by-sa 1,732 · cc-by 18,561.
