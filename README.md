...
|---|---|
| **Documents** | **667,629** |
| **Raw originals** | **~577G** (PDF / HTML / source code) |
| **Extracted text** | **~44G** (~43.681B chars, **≈10.920B tokens**) |
| **Cleaned corpus** | **~43G** (~41.943B chars, **≈10.486B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 228,329 · construction 135,442 · building_energy 126,781 · structures_civil 63,075 · materials 40,757 · infrastructure 27,173 · architecture 23,625 · standards_protocols 11,508 · urban 5,982 · controls_bas 4,137 · commissioning_fdd 820.

**By license:** open 482,203 · public-domain 165,520 · cc-by-sa 1,723 · cc-by 18,183.
