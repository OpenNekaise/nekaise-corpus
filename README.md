...
| **Extracted text** | **~63G** (~61.457B chars, **≈15.364B tokens**) |
| **Cleaned corpus** | **~60G** (~58.692B chars, **≈14.673B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 366,565 · construction 267,471 · building_energy 163,816 · structures_civil 111,447 · materials 74,847 · infrastructure 48,723 · architecture 32,781 · standards_protocols 11,527 · controls_bas 9,664 · urban 5,999 · commissioning_fdd 824.

**By license:** open 853,312 · public-domain 220,081 · cc-by-sa 1,732 · cc-by 18,539.
