...
| **Extracted text** | **~53G** (~51.651B chars, **≈12.913B tokens**) |
| **Cleaned corpus** | **~50G** (~49.500B chars, **≈12.375B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 281,483 · construction 184,646 · building_energy 141,002 · structures_civil 81,023 · materials 54,675 · infrastructure 35,592 · architecture 26,154 · standards_protocols 11,515 · urban 5,983 · controls_bas 5,395 · commissioning_fdd 819.

**By license:** open 611,897 · public-domain 196,398 · cc-by-sa 1,723 · cc-by 18,269.
