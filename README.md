...
| **Extracted text** | **~28G** (~27.550B chars, **≈6.887B tokens**) |
| **Cleaned corpus** | **~27G** (~26.571B chars, **≈6.643B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 116,425 · building_energy 86,531 · construction 68,764 · structures_civil 34,618 · materials 24,642 · infrastructure 14,585 · architecture 11,949 · standards_protocols 8,361 · controls_bas 3,396 · urban 3,032 · commissioning_fdd 374.

**By license:** open 242,031 · public-domain 100,582 · cc-by-sa 1,660 · cc-by 28,399 · proprietary-internal 5.
