...
| **Extracted text** | **~65G** (~64.014B chars, **≈16.003B tokens**) |
| **Cleaned corpus** | **~62G** (~61.078B chars, **≈15.270B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 390,623 · construction 291,712 · building_energy 170,673 · structures_civil 120,394 · materials 80,384 · infrastructure 53,157 · architecture 34,733 · standards_protocols 11,531 · controls_bas 10,213 · urban 6,002 · commissioning_fdd 826.

**By license:** open 923,654 · public-domain 226,247 · cc-by-sa 1,732 · cc-by 18,615.
