...
| **Extracted text** | **~65G** (~63.303B chars, **≈15.826B tokens**) |
| **Cleaned corpus** | **~61G** (~60.415B chars, **≈15.104B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 384,025 · construction 284,912 · building_energy 168,820 · structures_civil 117,886 · materials 78,860 · infrastructure 52,076 · architecture 34,233 · standards_protocols 11,529 · controls_bas 10,040 · urban 6,002 · commissioning_fdd 826.

**By license:** open 904,281 · public-domain 224,593 · cc-by-sa 1,732 · cc-by 18,603.
