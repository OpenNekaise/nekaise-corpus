...
| **Raw originals** | **~751G** (PDF / HTML / source code) |
| **Extracted text** | **~82G** (~79.842B chars, **≈19.961B tokens**) |
| **Cleaned corpus** | **~78G** (~75.888B chars, **≈18.972B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 535,867 · construction 431,357 · building_energy 214,977 · structures_civil 172,585 · materials 111,431 · infrastructure 75,654 · architecture 45,279 · standards_protocols 11,820 · controls_bas 11,211 · urban 6,108 · commissioning_fdd 841.

**By license:** open 1,331,765 · public-domain 263,470 · cc-by-sa 1,737 · cc-by 20,158.
<!-- STATS:END -->
