...
| **Extracted text** | **~69G** (~67.349B chars, **≈16.837B tokens**) |
| **Cleaned corpus** | **~65G** (~64.195B chars, **≈16.049B tokens**, ruleset-cleaned) |
| **Topics** | 11 |

**By topic** (a source gets one at registration): equipment_systems 420,748 · construction 321,873 · building_energy 179,363 · structures_civil 131,660 · materials 87,494 · infrastructure 57,845 · architecture 36,947 · standards_protocols 11,540 · controls_bas 10,989 · urban 6,005 · commissioning_fdd 830.

**By license:** open 1,011,030 · public-domain 233,841 · cc-by-sa 1,732 · cc-by 18,691.
